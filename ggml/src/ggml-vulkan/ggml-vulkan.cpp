...
#define CREATE_MM(TYPE, PIPELINE_NAME, NAMELC, F16ACC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID, REQSUBGROUPSIZE) \
        if (device->mul_mat ## ID ## _l[TYPE]) \
            ggml_vk_create_pipeline(device, device-> PIPELINE_NAME ->l, #NAMELC #F16ACC "_l", (device->dot2_f16 ? (unroll_bk ? NAMELC ## _dot2 ## F16ACC ## _len : NAMELC ## _dot2_rollbk ## F16ACC ## _len) : (unroll_bk ? NAMELC ## F16ACC ## _len : NAMELC ## _rollbk ## F16ACC ## _len)), (device->dot2_f16 ? (unroll_bk ? NAMELC ## _dot2 ## F16ACC ## _data : NAMELC ## _dot2_rollbk ## F16ACC ## _data) : (unroll_bk ? NAMELC ## F16ACC ## _data : NAMELC ## _rollbk ## F16ACC ## _data)), "main", PARAMCOUNT, sizeof(PUSHCONST), l_ ## WG_DENOMS, l_ ## WARPTILE, 1, false, REQSUBGROUPSIZE > 0, REQSUBGROUPSIZE);   \
        if (device->mul_mat ## ID ## _m[TYPE]) \
            ggml_vk_create_pipeline(device, device-> PIPELINE_NAME ->m, #NAMELC #F16ACC "_m", (device->dot2_f16 ? (unroll_bk ? NAMELC ## _dot2 ## F16ACC ## _len : NAMELC ## _dot2_rollbk ## F16ACC ## _len) : (unroll_bk ? NAMELC ## F16ACC ## _len : NAMELC ## _rollbk ## F16ACC ## _len)), (device->dot2_f16 ? (unroll_bk ? NAMELC ## _dot2 ## F16ACC ## _data : NAMELC ## _dot2_rollbk ## F16ACC ## _data) : (unroll_bk ? NAMELC ## F16ACC ## _data : NAMELC ## _rollbk ## F16ACC ## _data)), "main", PARAMCOUNT, sizeof(PUSHCONST), m_ ## WG_DENOMS, m_ ## WARPTILE, 1, false, REQSUBGROUPSIZE > 0, REQSUBGROUPSIZE);   \
        if (device->mul_mat ## ID ## _s[TYPE]) \
            ggml_vk_create_pipeline(device, device-> PIPELINE_NAME ->s, #NAMELC #F16ACC "_s", (device->dot2_f16 ? (unroll_bk ? NAMELC ## _dot2 ## F16ACC ## _len : NAMELC ## _dot2_rollbk ## F16ACC ## _len) : (unroll_bk ? NAMELC ## F16ACC ## _len : NAMELC ## _rollbk ## F16ACC ## _len)), (device->dot2_f16 ? (unroll_bk ? NAMELC ## _dot2 ## F16ACC ## _data : NAMELC ## _dot2_rollbk ## F16ACC ## _data) : (unroll_bk ? NAMELC ## F16ACC ## _data : NAMELC ## _rollbk ## F16ACC ## _data)), "main", PARAMCOUNT, sizeof(PUSHCONST), s_ ## WG_DENOMS, s_ ## WARPTILE, 1, false, REQSUBGROUPSIZE > 0, REQSUBGROUPSIZE);   \
        if (device->mul_mat ## ID ## _l[TYPE]) \
            ggml_vk_create_pipeline(device, device-> PIPELINE_NAME ->a_l, #NAMELC #F16ACC "_aligned_l", (device->dot2_f16 ? (unroll_bk ? NAMELC ## _dot2_aligned ## F16ACC ## _len : NAMELC ## _dot2_aligned_rollbk ## F16ACC ## _len) : (unroll_bk ? NAMELC ## _aligned ## F16ACC ## _len : NAMELC ## _aligned_rollbk ## F16ACC ## _len)), (device->dot2_f16 ? (unroll_bk ? NAMELC ## _dot2_aligned ## F16ACC ## _data : NAMELC ## _dot2_aligned_rollbk ## F16ACC ## _data) : (unroll_bk ? NAMELC ## _aligned ## F16ACC ## _data : NAMELC ## _aligned_rollbk ## F16ACC ## _data)), "main", PARAMCOUNT, sizeof(PUSHCONST), l_ ## WG_DENOMS, l_ ## WARPTILE, l_align, false, REQSUBGROUPSIZE > 0, REQSUBGROUPSIZE);   \
        if (device->mul_mat ## ID ## _m[TYPE]) \
            ggml_vk_create_pipeline(device, device-> PIPELINE_NAME ->a_m, #NAMELC #F16ACC "_aligned_m", (device->dot2_f16 ? (unroll_bk ? NAMELC ## _dot2_aligned ## F16ACC ## _len : NAMELC ## _dot2_aligned_rollbk ## F16ACC ## _len) : (unroll_bk ? NAMELC ## _aligned ## F16ACC ## _len : NAMELC ## _aligned_rollbk ## F16ACC ## _len)), (device->dot2_f16 ? (unroll_bk ? NAMELC ## _dot2_aligned ## F16ACC ## _data : NAMELC ## _dot2_aligned_rollbk ## F16ACC ## _data) : (unroll_bk ? NAMELC ## _aligned ## F16ACC ## _data : NAMELC ## _aligned_rollbk ## F16ACC ## _data)), "main", PARAMCOUNT, sizeof(PUSHCONST), m_ ## WG_DENOMS, m_ ## WARPTILE, m_align, false, REQSUBGROUPSIZE > 0, REQSUBGROUPSIZE);   \
        if (device->mul_mat ## ID ## _s[TYPE]) \
            ggml_vk_create_pipeline(device, device-> PIPELINE_NAME ->a_s, #NAMELC #F16ACC "_aligned_s", (device->dot2_f16 ? (unroll_bk ? NAMELC ## _dot2_aligned ## F16ACC ## _len : NAMELC ## _dot2_aligned_rollbk ## F16ACC ## _len) : (unroll_bk ? NAMELC ## _aligned ## F16ACC ## _len : NAMELC ## _aligned_rollbk ## F16ACC ## _len)), (device->dot2_f16 ? (unroll_bk ? NAMELC ## _dot2_aligned ## F16ACC ## _data : NAMELC ## _dot2_aligned_rollbk ## F16ACC ## _data) : (unroll_bk ? NAMELC ## _aligned ## F16ACC ## _data : NAMELC ## _aligned_rollbk ## F16ACC ## _data)), "main", PARAMCOUNT, sizeof(PUSHCONST), s_ ## WG_DENOMS, s_ ## WARPTILE, s_align, false, REQSUBGROUPSIZE > 0, REQSUBGROUPSIZE);   \
...
#define CREATE_MM2(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID, REQSUBGROUPSIZE) \
        ...
        // Roll the mul_mm BK loop on Asahi Linux
