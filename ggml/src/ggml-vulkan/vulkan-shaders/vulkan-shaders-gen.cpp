...
void process_shaders() {
    ...
    string_to_spv("cpy_bf16_bf16","copy.comp", {{"A_TYPE", "uint16_t"}, {"D_TYPE", "uint16_t"}});
    ...
    string_to_spv("contig_cpy_bf16_bf16","contig_copy.comp",{{"A_TYPE", "uint16_t"}, {"D_TYPE", "uint16_t"}});
