...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q4_H] = {
        .type_name                = "q4_h",
        .blck_size                = QK4_H,
        .type_size                = sizeof(block_q4_h),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_h,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q4_h_ref,
    },
    [4] = { // GGML_TYPE_Q4_2
...
enum ggml_type ggml_ftype_to_ggml_type(enum ggml_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case GGML_FTYPE_MOSTLY_Q4_H:          wtype = GGML_TYPE_Q4_H;  break;
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_Q4_H:    result = quantize_q4_h   (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
