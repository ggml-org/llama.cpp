...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q1_5_K] = {
        .type_name                = "q1_5_K",
        .blck_size                = QK_K,
        .type_size                = sizeof(block_q1_5_K),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q1_5_K,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q1_5_K_ref,
    },
    [GGML_TYPE_Q2_K_S] = {
        .type_name                = "q2_K_s",
        .blck_size                = QK_K,
        .type_size                = sizeof(block_q2_K_s),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q2_K_s,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q2_K_s_ref,
    },
    [GGML_TYPE_Q2_K] = {
        .type_name                = "q2_K",
        .blck_size                = QK_K,
...
size_t ggml_quantize_chunk(enum ggml_type type,
    ...
    switch (type) {
        ...
        case GGML_TYPE_TQ2_0:
            ...
            break;
        case GGML_TYPE_Q1_5_K:
            result = quantize_q1_5_K(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix);
            break;
        case GGML_TYPE_Q2_K_S:
            result = quantize_q2_K_s(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix);
            break;
        case GGML_TYPE_IQ2_XXS:
