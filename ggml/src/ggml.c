...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_STQ_0] = {
        .type_name                = "stq_0",
        .blck_size                = QK_K,
        .type_size                = sizeof(block_stq_0),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_stq_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_stq_0_ref,
    },
};
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_STQ_0:   result = quantize_stq_0  (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
