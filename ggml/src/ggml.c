...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q4_0_BLUE] = {
        ...
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q4_0_blue_ref,
    },
    [GGML_TYPE_Q4_1] = {
        .type_name                = "q4_1",
        .blck_size                = QK4_1,
    ...
    [GGML_TYPE_Q4_1_BLUE] = {
        ...
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_1,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q4_1_blue_ref,
    },
    [4] = { // GGML_TYPE_Q4_2
    ...
    [GGML_TYPE_Q2_K_BLUE] = {
        ...
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q2_K,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q2_K_blue_ref,
    },
    [GGML_TYPE_Q3_K_BLUE] = {
        .type_name                = "q3_K_blue",
        .blck_size                = QK_K,
        ...
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q3_K,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q3_K_blue_ref,
    },
    [GGML_TYPE_Q4_K] = {
        .type_name                = "q4_K",
        .blck_size                = QK_K,
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_Q4_0_BLUE: result = quantize_q4_0_blue(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q4_1_BLUE: result = quantize_q4_1_blue(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        ...
        case GGML_TYPE_Q2_K_BLUE: result = quantize_q2_K_blue(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q3_K:      result = quantize_q3_K     (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q3_K_BLUE: result = quantize_q3_K_blue(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
