...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q4_T] = {
        .type_name                = "Q4_T",
        .blck_size                = QK_T,
        .type_size                = sizeof(block_q4_t),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_t,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q4_t_ref,
    },
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_Q4_T:    result = quantize_q4_t   (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
