...
GGML_API void quantize_row_stq_0_ref(const float * GGML_RESTRICT x, block_stq_0 * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_stq_0(const block_stq_0 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_stq_0(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
