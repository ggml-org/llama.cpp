...
GGML_API void ggml_infer_q4_0_qat_scales(const float * GGML_RESTRICT src, ggml_half * GGML_RESTRICT scales, int64_t k);
...
GGML_API size_t quantize_q4_0_qat(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrow, int64_t n_per_row, const ggml_half * GGML_RESTRICT scales);
