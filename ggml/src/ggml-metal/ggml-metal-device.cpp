...
ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_log_soft_max(ggml_metal_library_t lib, const ggml_tensor * op) {
    ...
    snprintf(base, 256, "kernel_log_soft_max_f32%s", suffix);
    snprintf(name, 256, "%s", base);
