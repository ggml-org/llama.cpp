...
template [[host_name("kernel_mul_mv_ext_nvfp4_f32_r1_2")]]  kernel mul_mv_ext_q4_f32_t kernel_mul_mv_ext_q4_f32_disp<2, block_nvfp4,  16, dequantize_nvfp4_t4>;
template [[host_name("kernel_mul_mv_ext_nvfp4_f32_r1_3")]]  kernel mul_mv_ext_q4_f32_t kernel_mul_mv_ext_q4_f32_disp<3, block_nvfp4,  16, dequantize_nvfp4_t4>;
template [[host_name("kernel_mul_mv_ext_nvfp4_f32_r1_4")]]  kernel mul_mv_ext_q4_f32_t kernel_mul_mv_ext_q4_f32_disp<4, block_nvfp4,  16, dequantize_nvfp4_t4>;
template [[host_name("kernel_mul_mv_ext_nvfp4_f32_r1_5")]]  kernel mul_mv_ext_q4_f32_t kernel_mul_mv_ext_q4_f32_disp<5, block_nvfp4,  16, dequantize_nvfp4_t4>;
...
void kernel_mul_mv_nvfp4_f32_impl(
    ...
    // Each thread handles one NVFP4 block (16 elements = 8 qs bytes)
    for (int ib = tiisg; ib < nb && ib < ns01; ib += 32) {
        device const float * yb = y + ib*QK_NVFP4;
        ...
        FOR_UNROLL (short row = 0; row < NR0; row++) {
            ...
            for (int j = 0; j < QK_NVFP4/2; ++j) {
                acc += yb[j          ] * shmem_f32[q2[j] & 0x0F];
                acc += yb[j + QK_NVFP4/2] * shmem_f32[q2[j] >> 4];
            }
...
template [[host_name("kernel_get_rows_nvfp4")]]   kernel get_rows_q_t kernel_get_rows_q<block_nvfp4,   2, dequantize_nvfp4>;
...
template [[host_name("kernel_mul_mm_nvfp4_f32")]]   kernel mul_mm_t kernel_mul_mm<half,   half4x4,   simdgroup_half8x8,   half,   half2x4,   simdgroup_half8x8,   block_nvfp4,   2,     dequantize_nvfp4,   float,  float4x4,  float, float2x4>;
...
template [[host_name("kernel_mul_mm_nvfp4_f16")]]   kernel mul_mm_t kernel_mul_mm<half,   half4x4,   simdgroup_half8x8,   half,   half2x4,   simdgroup_half8x8,   block_nvfp4,   2,     dequantize_nvfp4,   float,  float4x4,  half, half2x4>;
...
template [[host_name("kernel_mul_mm_id_nvfp4_f32")]]   kernel mul_mm_id kernel_mul_mm_id<half,   half4x4,   simdgroup_half8x8,   half,   half2x4,   simdgroup_half8x8,   block_nvfp4,   2,     dequantize_nvfp4,   float,  float4x4,  float, float2x4>;
...
template [[host_name("kernel_mul_mm_id_nvfp4_f16")]]   kernel mul_mm_id kernel_mul_mm_id<half,   half4x4,   simdgroup_half8x8,   half,   half2x4,   simdgroup_half8x8,   block_nvfp4,   2,     dequantize_nvfp4,   float,  float4x4,  half, half2x4>;
