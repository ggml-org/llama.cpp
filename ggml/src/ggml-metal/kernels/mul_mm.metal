...
template [[host_name("kernel_mul_mm_bposit8_f32")]]    kernel mul_mm_t kernel_mul_mm<half,   half4x4,   simdgroup_half8x8,   half,   half2x4,   simdgroup_half8x8,   block_bposit8, 2,     dequantize_bposit8, float,  float4x4,  float, float2x4>;
...
template [[host_name("kernel_mul_mm_bposit8_f16")]]    kernel mul_mm_t kernel_mul_mm<half,   half4x4,   simdgroup_half8x8,   half,   half2x4,   simdgroup_half8x8,   block_bposit8, 2,     dequantize_bposit8, float,  float4x4,  half, half2x4>;
...
template [[host_name("kernel_mul_mm_id_bposit8_f32")]]    kernel mul_mm_id kernel_mul_mm_id<half,   half4x4,   simdgroup_half8x8,   half,   half2x4,   simdgroup_half8x8,   block_bposit8, 2,     dequantize_bposit8, float,  float4x4,  float, float2x4>;
...
template [[host_name("kernel_mul_mm_id_bposit8_f16")]]    kernel mul_mm_id kernel_mul_mm_id<half,   half4x4,   simdgroup_half8x8,   half,   half2x4,   simdgroup_half8x8,   block_bposit8, 2,     dequantize_bposit8, float,  float4x4,  half, half2x4>;
