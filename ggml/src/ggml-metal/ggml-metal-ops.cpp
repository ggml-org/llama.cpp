...
int ggml_metal_op_mul_mat(ggml_metal_op_t ctx, int idx) {
    ...
    // Gate per device rather than changing the default for hardware where it wins.
    const bool kq_ext_ok = props_dev->device_id != GGML_METAL_DEVICE_M3_PRO;
