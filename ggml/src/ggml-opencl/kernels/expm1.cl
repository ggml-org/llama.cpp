...
kernel void kernel_expm1_f16(
    ...
    dst[get_global_id(0)] = convert_half(exp(convert_float(src0[get_global_id(0)]))) - 1.0h;
}
...
kernel void kernel_expm1_f16_4(
    ...
    dst[get_global_id(0)] = convert_half4(exp(convert_float4(src0[get_global_id(0)]))) - 1.0h;
}
...
kernel void kernel_expm1_f16_nc(
    ...
    for (int i0 = get_local_id(0); i0 < ne00; i0 += get_local_size(0)) {
        ...
        *y = convert_half(exp(convert_float(*x)) - 1.0f);
    }
}
