...
static inline void hvx_dot_f16_f16_aa(float * restrict r, const void * restrict x, const void * restrict y, unsigned int n, float s) {
    ...
    for (i = 0; i < nvec; i++) {
        ...
        rsum_p = Q6_Wsf_vmpyacc_WsfVhfVhf(rsum_p, x_hf, y_hf);
    }
    ...
    HVX_Vector rsum = Q6_Vsf_vadd_VsfVsf(Q6_V_lo_W(rsum_p), Q6_V_hi_W(rsum_p));
    rsum = Q6_Vsf_vmpy_VsfVsf(hvx_vec_splat_f32(s), hvx_vec_reduce_sum_f32(rsum));
...
static inline HVX_Vector hvx_dot_f16_f16_aa_rx4(const void * restrict y,
    ...
    for (i = 0; i < nvec; i++) {
        ...
        rsum0_p = Q6_Wsf_vmpyacc_WsfVhfVhf(rsum0_p, x0_hf, y_hf);
        rsum1_p = Q6_Wsf_vmpyacc_WsfVhfVhf(rsum1_p, x1_hf, y_hf);
        rsum2_p = Q6_Wsf_vmpyacc_WsfVhfVhf(rsum2_p, x2_hf, y_hf);
        rsum3_p = Q6_Wsf_vmpyacc_WsfVhfVhf(rsum3_p, x3_hf, y_hf);
    }
    ...
    HVX_Vector rsum0 = Q6_Vsf_vadd_VsfVsf(Q6_V_lo_W(rsum0_p), Q6_V_hi_W(rsum0_p));
    HVX_Vector rsum1 = Q6_Vsf_vadd_VsfVsf(Q6_V_lo_W(rsum1_p), Q6_V_hi_W(rsum1_p));
    HVX_Vector rsum2 = Q6_Vsf_vadd_VsfVsf(Q6_V_lo_W(rsum2_p), Q6_V_hi_W(rsum2_p));
    HVX_Vector rsum3 = Q6_Vsf_vadd_VsfVsf(Q6_V_lo_W(rsum3_p), Q6_V_hi_W(rsum3_p));
