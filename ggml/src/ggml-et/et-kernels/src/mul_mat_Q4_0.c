            ...
            for (int64_t i2 = 0; i2 < ne12; i2++) {
                ...
                for (int64_t n = 0; n < N; n++) {
                    ...
                    for (int64_t m = minion_id; m < M; m += STRIDE_M_KSPLIT) {
                        ...
                        float partial = compute_row_dot_q4_0(
                ...
                for (int64_t n = 0; n < N; n++) {
                    ...
                    for (int64_t m_base = minion_id; m_base < M;
                        ...
                        for (int64_t kb = 0; kb < K_blocks; kb += TILE_KB) {
                            ...
                            if (m0 < M) {
                                s0 += compute_row_dot_q4_0(
                                    (const block_q4_0*)(src0_ptr2 + m0 * nb01) + row_kb,
                                    b_tile, tile_len);
                            }
                            if (m1 < M) {
                                s1 += compute_row_dot_q4_0(
                                    (const block_q4_0*)(src0_ptr2 + m1 * nb01) + row_kb,
                                    b_tile, tile_len);
                            }
                            if (m2 < M) {
                                s2 += compute_row_dot_q4_0(
                                    (const block_q4_0*)(src0_ptr2 + m2 * nb01) + row_kb,
                                    b_tile, tile_len);
                            }
                            if (m3 < M) {
                                s3 += compute_row_dot_q4_0(
                                    (const block_q4_0*)(src0_ptr2 + m3 * nb01) + row_kb,
                                    b_tile, tile_len);
                            }
                        }
                ...
                for (int64_t n = 0; n < N; n++) {
                    ...
                    for (int64_t m0 = hart_id; m0 < M; m0 += STRIDE_M * 4) {
                        ...
                        for (int64_t kb = 0; kb < K_blocks; kb += TILE_KB) {
                            ...
                            s0 += compute_row_dot_q4_0(
                                (const block_q4_0*)(src0_ptr2 + m0 * nb01) + kb,
                                b_tile, tile_len);
                            if (m1 < M) {
                                s1 += compute_row_dot_q4_0(
                                    (const block_q4_0*)(src0_ptr2 + m1 * nb01) + kb,
                                    b_tile, tile_len);
                            }
                            if (m2 < M) {
                                s2 += compute_row_dot_q4_0(
                                    (const block_q4_0*)(src0_ptr2 + m2 * nb01) + kb,
                                    b_tile, tile_len);
                            }
                            if (m3 < M) {
                                s3 += compute_row_dot_q4_0(
                                    (const block_q4_0*)(src0_ptr2 + m3 * nb01) + kb,
                                    b_tile, tile_len);
                            }
                        }
