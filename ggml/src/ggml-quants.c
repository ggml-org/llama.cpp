...
// the dense-trit packing writes 120 of the 128 trits in 5-per-byte groups, using
// three strides so that every byte carries five trits in the same position
