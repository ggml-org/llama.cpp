...
TYPES_MMVQ = TYPES_MMQ + ["GGML_TYPE_IQ1_M"]

SOURCE_MMVQ = """// This file has been autogenerated by generate_cu_files.py, do not edit manually.
...
SOURCE_MMVF = """// This file has been autogenerated by generate_cu_files.py, do not edit manually.

#include "../mmvf.cuh"

DECL_MMVF_CASE({ncols});
"""
...
for type in TYPES_MMVQ:
    with open(f"mmvq-instance-{get_short_name(type)}.cu", "w") as f:
        f.write(SOURCE_MMVQ.format(type=type))

for ncols in range(1, 9):
    with open(f"mmvf-instance-ncols_{ncols}.cu", "w") as f:
        f.write(SOURCE_MMVF.format(ncols=ncols))
