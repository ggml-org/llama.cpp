...
SOURCE_FATTN_MMA_BF16_START = """// This file has been autogenerated by generate_cu_files.py, do not edit manually.

#include "../fattn-mma-bf16.cuh"

"""

SOURCE_FATTN_MMA_BF16_CASE = "DECL_FATTN_MMA_BF16_CASE({head_size_kq}, {head_size_v}, {ncols1}, {ncols2});\n"
...
for ncols in [8, 16, 32, 64]:
    for ncols2 in [1, 2, 4, 8, 16, 32]:
        if ncols2 > ncols:
            continue
        ncols1 = ncols // ncols2
        with open(f"fattn-mma-bf16-instance-ncols1_{ncols1}-ncols2_{ncols2}.cu", "w") as f:
            f.write(SOURCE_FATTN_MMA_BF16_START)
            ...
            for head_size_kq in HEAD_SIZES_KQ:
                ...
                if head_size_kq not in (192, 320, 576) and ncols2 in (16, 32):
                    continue
                head_size_v = HEAD_SIZES_V_OVERRIDE.get(head_size_kq, head_size_kq)
                f.write(SOURCE_FATTN_MMA_BF16_CASE.format(ncols1=ncols1, ncols2=ncols2, head_size_kq=head_size_kq, head_size_v=head_size_v))
