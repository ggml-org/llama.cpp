...
# K/V pairs outside the cross product above, kept small on purpose - see ggml_cuda_fattn_vec_kv_combo_supported
TYPES_KV_EXTRA_PAIRS = [
    ("GGML_TYPE_Q4_H", "GGML_TYPE_F16"),
    ("GGML_TYPE_F16",  "GGML_TYPE_Q4_H"),
    ("GGML_TYPE_Q4_H", "GGML_TYPE_Q4_H"),
    ("GGML_TYPE_Q8_0", "GGML_TYPE_Q4_H"),
]
...
TYPES_MMQ = [
    "GGML_TYPE_Q1_0",
    "GGML_TYPE_Q2_0",
    "GGML_TYPE_Q4_0", "GGML_TYPE_Q4_1", "GGML_TYPE_Q4_H", "GGML_TYPE_Q5_0", "GGML_TYPE_Q5_1", "GGML_TYPE_Q8_0",
...
for type_k, type_v in [(k, v) for k in TYPES_KV for v in TYPES_KV] + TYPES_KV_EXTRA_PAIRS:
