    ...
    for ncols2 in [1, 2, 4, 8, 16]:
        ...
        with open(f"fattn-mma-f16-instance-ncols1_{ncols1}-ncols2_{ncols2}.cu", "w") as f:
            ...
            for head_size_kq in [64, 80, 96, 112, 128, 256, 576]:
                ...
                for nstages in [0, 1, 2]:
                    if head_size_kq == 576 and nstages == 2:
                        continue
                    f.write(SOURCE_FATTN_MMA_CASE.format(
                        ncols1=ncols1, ncols2=ncols2, head_size_kq=head_size_kq, head_size_v=head_size_v, nstages=nstages))
