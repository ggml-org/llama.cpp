...
static bool ggml_cuda_compute_forward(ggml_backend_cuda_context & ctx, struct ggml_tensor * dst) {
    switch (dst->op) {
        ...
        case GGML_OP_DSV4_HC_POST:
            ...
            break;
        case GGML_OP_XC4_HC_COMB:
            ggml_cuda_op_xc4_hc_comb(ctx, dst);
            break;
        case GGML_OP_XC4_HC_PRE:
            ggml_cuda_op_xc4_hc_pre(ctx, dst);
            break;
        case GGML_OP_XC4_HC_POST:
            ggml_cuda_op_xc4_hc_post(ctx, dst);
            break;
