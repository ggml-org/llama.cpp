...
static constexpr __device__ vec_dot_q_cuda_t get_vec_dot_q_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_IQ2_NL:  return vec_dot_iq2_nl_q8_1;
        case GGML_TYPE_IQ3_NL:  return vec_dot_iq3_nl_q8_1;
...
static constexpr __host__ __device__ int get_vdr_mmvq(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_IQ2_NL:  return VDR_IQ2_NL_Q8_1_MMVQ;
        case GGML_TYPE_IQ3_NL:  return VDR_IQ3_NL_Q8_1_MMVQ;
...
static void mul_mat_vec_q_switch_type(
    ...
    switch (type_x) {
        ...
        case GGML_TYPE_IQ2_NL:
            mul_mat_vec_q_switch_ncols_dst<GGML_TYPE_IQ2_NL>
                (vx, vy, ids, fusion, dst, ncols_x, nrows_x, ncols_dst, stride_row_x, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y, stride_channel_dst,
                 nsamples_x, nsamples_dst, stride_sample_x, stride_sample_y, stride_sample_dst, ids_stride, stream);
            break;
        case GGML_TYPE_IQ3_NL:
            mul_mat_vec_q_switch_ncols_dst<GGML_TYPE_IQ3_NL>
                (vx, vy, ids, fusion, dst, ncols_x, nrows_x, ncols_dst, stride_row_x, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y, stride_channel_dst,
                 nsamples_x, nsamples_dst, stride_sample_x, stride_sample_y, stride_sample_dst, ids_stride, stream);
            break;
