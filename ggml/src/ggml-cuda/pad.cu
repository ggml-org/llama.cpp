...
static __global__ void pad_f32(const float * src,
                               float *       dst,
                               const int     lp0,
                               const int     rp0,
                               const int     lp1,
...
static void pad_f32_cuda(const float * src,
                         float *       dst,
                         const int     lp0,
                         const int     rp0,
                         const int     lp1,
    ...
    pad_f32<<<gridDim, CUDA_PAD_BLOCK_SIZE, 0, stream>>>(src, dst, lp0, rp0, lp1, rp1, lp2, rp2, lp3, rp3, ne0, ne1,
                                                         ne2, ne3, circular);
}
