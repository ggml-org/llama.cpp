...
static void ggml_sycl_flash_attn_ext_vec(ggml_backend_sycl_context & ctx, ggml_tensor * dst) {
    ...
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_Q4_0_BLUE, GGML_TYPE_F16)
    ...
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_Q4_0_BLUE, GGML_TYPE_Q4_0)
    ...
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_Q4_0_BLUE, GGML_TYPE_Q4_1)
    ...
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_Q4_0_BLUE, GGML_TYPE_Q5_0)
    ...
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_Q4_0_BLUE, GGML_TYPE_Q5_1)
    ...
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_Q4_0_BLUE, GGML_TYPE_Q8_0)
    ...
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_F16,  GGML_TYPE_F16)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_Q4_0, GGML_TYPE_Q4_0)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_Q4_0_BLUE, GGML_TYPE_Q4_0_BLUE)
    FATTN_VEC_CASES_ALL_D(GGML_TYPE_Q8_0, GGML_TYPE_Q8_0)
