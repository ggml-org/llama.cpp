...
void ggml_gemm_q6_K_8x8_q8_K(int                        n,
                             ...
                             int                        nr,
                             int                        nc) {
    // std::cout<<"ggml_gemm_q6_K_8x8_q8_K called";
    constexpr int qk = QK_K;
    const int     nb = n / qk;
    ...
    switch(svcntb() * 8){
        ...
        //     svbool_t ph = svptrue_pat_b8(SV_VL16);
        //     svbool_t pl = svnot_b_z(svptrue_b8(), ph);
        ...
        //                     svint8_t q8_qs_0 = svadd_s8_x(svptrue_b8(), svld1_s8(ph, q8_base_1 + 0), svld1_s8(pl, q8_base_1 + 112));
        //                     svint8_t q8_qs_2 = svadd_s8_x(svptrue_b8(), svld1_s8(ph, q8_base_1 + 64), svld1_s8(pl, q8_base_1 + 144));
        //                     svint8_t q8_qs_4 = svadd_s8_x(svptrue_b8(), svld1_s8(ph, q8_base_1 + 128), svld1_s8(pl, q8_base_1 + 176));
        //                     svint8_t q8_qs_6 = svadd_s8_x(svptrue_b8(), svld1_s8(ph, q8_base_1 + 192), svld1_s8(pl, q8_base_1 + 208));

        //                     svint8_t q8_qs_1 = svadd_s8_x(svptrue_b8(), svld1_s8(ph, q8_base_1 + 16), svld1_s8(pl, q8_base_1 + 128));
        //                     svint8_t q8_qs_3 = svadd_s8_x(svptrue_b8(), svld1_s8(ph, q8_base_1 + 80), svld1_s8(pl, q8_base_1 + 160));
        //                     svint8_t q8_qs_5 = svadd_s8_x(svptrue_b8(), svld1_s8(ph, q8_base_1 + 144), svld1_s8(pl, q8_base_1 + 192));
        //                     svint8_t q8_qs_7 = svadd_s8_x(svptrue_b8(), svld1_s8(ph, q8_base_1 + 208), svld1_s8(pl, q8_base_1 + 224));

        //                     const int8_t *base_scale_ptr = q6_ptr[b].scales+(sb/2)*64+(sb%2)*16;

        //                     // Q4s columns iterated in pairs (01, 23, 45, 67)
        //                     for (int cp = 0; cp < ncols_interleaved / 2; cp++) {
        //                         svint32_t sb_acc_0_s0 = svdup_n_s32(0);
        //                         svint32_t sb_acc_0_s1 = svdup_n_s32(0);
        //                         svint32_t sb_acc_2_s0 = svdup_n_s32(0);
        //                         svint32_t sb_acc_2_s1 = svdup_n_s32(0);

        //                         svuint8_t q6_qs_cp_00_l = svld1rq_u8(svptrue_b8(), q6_ptr[b].ql + sb * QK_K + 16 * cp + 0);
        //                         svuint8_t q6_qs_cp_01_l = svld1rq_u8(svptrue_b8(), q6_ptr[b].ql + sb * QK_K + 16 * cp + 64);
        //                         svuint8_t q6_qs_cp_02_l = svld1rq_u8(svptrue_b8(), q6_ptr[b].ql + sb * QK_K + 16 * cp + 128);
        //                         svuint8_t q6_qs_cp_03_l = svld1rq_u8(svptrue_b8(), q6_ptr[b].ql + sb * QK_K + 16 * cp + 192);

        //                         // we divide by 2 because for sb=0, range is [0 to 255] 
        //                         // but for sb=2, range is [256, 511]
                                
        //                         svuint8_t q6_qs_cp_00_h = svld1rq_u8(svptrue_b8(), q6_ptr[b].qh + (sb * QK_K)/2 + 16 * cp + 0);
        //                         svuint8_t q6_qs_cp_01_h = svld1rq_u8(svptrue_b8(), q6_ptr[b].qh + (sb * QK_K)/2 + 16 * cp + 64);
        //                         svuint8_t q6_qs_cp_02_h = svld1rq_u8(svptrue_b8(), q6_ptr[b].qh + (sb * QK_K)/2 + 16 * cp + 128);
        //                         svuint8_t q6_qs_cp_03_h = svld1rq_u8(svptrue_b8(), q6_ptr[b].qh + (sb * QK_K)/2 + 16 * cp + 192);

        //                         //shift qh by 2 bits if sb == 1 or 3 since those indexes hold qh values at offset 64
        //                         if(sb==1||sb==3){
        //                             q6_qs_cp_00_h = svlsr_n_u8_x(pg8_32,q6_qs_cp_00_h, 2);
        //                             q6_qs_cp_01_h = svlsr_n_u8_x(pg8_32,q6_qs_cp_01_h, 2);
        //                             q6_qs_cp_02_h = svlsr_n_u8_x(pg8_32,q6_qs_cp_02_h, 2);
        //                             q6_qs_cp_03_h = svlsr_n_u8_x(pg8_32,q6_qs_cp_03_h, 2);
        //                         }

        //                         //Create the entire q values from ql and qh
        //                         // svuint8_t ql = svlsr_n_u8_m(pl, svand_u8_m(ph, q6_qs_cp_00_l, m4b), 4);
        //                         // svuint8_t qh = svand_u8_m(pl, svlsl_n_u8_m(ph, svand_u8_m(ph, q6_qs_cp_00_h, mask_lo), 4), mask_hi);
        //                         // svuint8_t q = svreinterpret_s8_u8(svorr_u8_x(pg8_32, ql, qh));

        //                         svint8_t q6_qs_cp_00 = svreinterpret_s8_u8(
        //                                                     svorr_u8_x(pg8_32, 
        //                                                         svlsr_n_u8_m(pl, svand_u8_m(ph, q6_qs_cp_00_l, m4b), 4), //ql part
        //                                                         svand_u8_m(pl, svlsl_n_u8_m(ph, svand_u8_m(ph, q6_qs_cp_00_h, mask_lo), 4), mask_hi) //qh part
        //                                                     ));

        //                         svint8_t q6_qs_cp_01 = svreinterpret_s8_u8(
        //                                                     svorr_u8_x(pg8_32, 
        //                                                         svlsr_n_u8_m(pl, svand_u8_m(ph, q6_qs_cp_01_l, m4b), 4), //ql part
        //                                                         svand_u8_m(pl, svlsl_n_u8_m(ph, svand_u8_m(ph, q6_qs_cp_01_h, mask_lo), 4), mask_hi) //qh part
        //                                                     ));

        //                         svint8_t q6_qs_cp_02 = svreinterpret_s8_u8(
        //                                                     svorr_u8_x(pg8_32, 
        //                                                         svlsr_n_u8_m(pl, svand_u8_m(ph, q6_qs_cp_02_l, m4b), 4), //ql part
        //                                                         svand_u8_m(pl, svlsl_n_u8_m(ph, svand_u8_m(ph, q6_qs_cp_02_h, mask_lo), 4), mask_hi) //qh part
        //                                                     ));

        //                         svint8_t q6_qs_cp_03 = svreinterpret_s8_u8(
        //                                                     svorr_u8_x(pg8_32, 
        //                                                         svlsr_n_u8_m(pl, svand_u8_m(ph, q6_qs_cp_03_l, m4b), 4), //ql part
        //                                                         svand_u8_m(pl, svlsl_n_u8_m(ph, svand_u8_m(ph, q6_qs_cp_03_h, mask_lo), 4), mask_hi) //qh part
        //                                                     ));
                                                            
        //                         //Signed 32 correction
        //                         q6_qs_cp_00 = svsub_n_s8_x(pg8_32, q6_qs_cp_00, 32);
        //                         q6_qs_cp_01 = svsub_n_s8_x(pg8_32, q6_qs_cp_01, 32);
        //                         q6_qs_cp_02 = svsub_n_s8_x(pg8_32, q6_qs_cp_02, 32);
        //                         q6_qs_cp_03 = svsub_n_s8_x(pg8_32, q6_qs_cp_03, 32);

        //                         sb_acc_0_s0 = svmmla_s32(sb_acc_0_s0, q6_qs_cp_00, q8_qs_0);
        //                         sb_acc_0_s0 = svmmla_s32(sb_acc_0_s0, q6_qs_cp_01, q8_qs_2);

        //                         sb_acc_0_s1 = svmmla_s32(sb_acc_0_s1, q6_qs_cp_02, q8_qs_4);
        //                         sb_acc_0_s1 = svmmla_s32(sb_acc_0_s1, q6_qs_cp_03, q8_qs_6);

        //                         sb_acc_2_s0 = svmmla_s32(sb_acc_2_s0, q6_qs_cp_00, q8_qs_1);
        //                         sb_acc_2_s0 = svmmla_s32(sb_acc_2_s0, q6_qs_cp_01, q8_qs_3);

        //                         sb_acc_2_s1 = svmmla_s32(sb_acc_2_s1, q6_qs_cp_02, q8_qs_5);
        //                         sb_acc_2_s1 = svmmla_s32(sb_acc_2_s1, q6_qs_cp_03, q8_qs_7);

        //                         const int scale_col = 2 * cp;

        //                         int32_t scale_arr_0[8] = {
        //                             //Low lanes
        //                             base_scale_ptr[scale_col +  0],
        //                             base_scale_ptr[scale_col +  0],
        //                             base_scale_ptr[scale_col +  1],
        //                             base_scale_ptr[scale_col +  1],
        //                             //High Lanes
        //                             base_scale_ptr[scale_col + 32],
        //                             base_scale_ptr[scale_col + 32],
        //                             base_scale_ptr[scale_col + 33],
        //                             base_scale_ptr[scale_col + 33],
        //                         };

        //                         int32_t scale_arr_1[8] = {
        //                             //Low lanes
        //                             base_scale_ptr[scale_col +  8],
        //                             base_scale_ptr[scale_col +  8],
        //                             base_scale_ptr[scale_col +  9],
        //                             base_scale_ptr[scale_col +  9],
        //                             //High Lanes
        //                             base_scale_ptr[scale_col + 40],
        //                             base_scale_ptr[scale_col + 40],
        //                             base_scale_ptr[scale_col + 41],
        //                             base_scale_ptr[scale_col + 41],
        //                         };

        //                         const svint32_t scale_vec_0 =
        //                             svld1_s32(pg32_8, scale_arr_0);

        //                         const svint32_t scale_vec_1 =
        //                             svld1_s32(pg32_8, scale_arr_1);

        //                         if(cp == 0) {
        //                             acc_00 = svmla_s32_m(svptrue_b32(), acc_00, sb_acc_0_s0, scale_vec_0);
        //                             acc_00 = svmla_s32_m(svptrue_b32(), acc_00, sb_acc_0_s1, scale_vec_1);
        //                             acc_44 = svmla_s32_m(svptrue_b32(), acc_44, sb_acc_2_s0, scale_vec_0);
        //                             acc_44 = svmla_s32_m(svptrue_b32(), acc_44, sb_acc_2_s1, scale_vec_1);
        //                         }
        //                         if(cp == 1) {
        //                             acc_11 = svmla_s32_m(svptrue_b32(), acc_11, sb_acc_0_s0, scale_vec_0);
        //                             acc_11 = svmla_s32_m(svptrue_b32(), acc_11, sb_acc_0_s1, scale_vec_1);
        //                             acc_55 = svmla_s32_m(svptrue_b32(), acc_55, sb_acc_2_s0, scale_vec_0);
        //                             acc_55 = svmla_s32_m(svptrue_b32(), acc_55, sb_acc_2_s1, scale_vec_1);
        //                         }
        //                         if(cp == 2) {
        //                             acc_22 = svmla_s32_m(svptrue_b32(), acc_22, sb_acc_0_s0, scale_vec_0);
        //                             acc_22 = svmla_s32_m(svptrue_b32(), acc_22, sb_acc_0_s1, scale_vec_1);
        //                             acc_66 = svmla_s32_m(svptrue_b32(), acc_66, sb_acc_2_s0, scale_vec_0);
        //                             acc_66 = svmla_s32_m(svptrue_b32(), acc_66, sb_acc_2_s1, scale_vec_1);
        //                         }
        //                         if(cp == 3) {
        //                             acc_33 = svmla_s32_m(svptrue_b32(), acc_33, sb_acc_0_s0, scale_vec_0);
        //                             acc_33 = svmla_s32_m(svptrue_b32(), acc_33, sb_acc_0_s1, scale_vec_1);
        //                             acc_77 = svmla_s32_m(svptrue_b32(), acc_77, sb_acc_2_s0, scale_vec_0);
        //                             acc_77 = svmla_s32_m(svptrue_b32(), acc_77, sb_acc_2_s1, scale_vec_1);
        //                         }
        //                     } // for cp
        //                 }  // for sb
        ...
        //                 // Broadcast q8 scalar
        //                 svfloat32_t q8_d = svdup_f32(q8_ptr[b].d[0]);
        //                 svfloat32_t q6_d = svcvt_f32_f16_x(svptrue_b32(), svzip1_f16( svld1_f16(svptrue_pat_b16(SV_VL8), (const __fp16 *)q6_ptr[b].d), svdup_f16(0)));
        //                 svfloat32_t scale1 = svmul_f32_x(svptrue_b32(), q6_d, q8_d);
        //                 acc_f32_01 = svmla_f32_m(svptrue_b32(), acc_f32_01, svcvt_f32_s32_m(svdup_n_f32(0), svptrue_b32(), reorder_acc_01), scale1);

        //                 q8_d = svdup_f32(q8_ptr[b].d[1]);
        //                 scale1 = svmul_f32_x(svptrue_b32(), q6_d, q8_d);
        //                 acc_f32_23 = svmla_f32_m(svptrue_b32(), acc_f32_23, svcvt_f32_s32_m(svdup_n_f32(0), svptrue_b32(), reorder_acc_23), scale1);
