...
void ggml_gemm_q4_K_8x4_q8_K(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, const void * GGML_RESTRICT vy, int nr, int nc) {
    ...
    for (int y = 0; y < nr / q8_k_blocklen; y++) {
        ...
        for (int x = 0; x < nc / ncols_interleaved; x++) {
            ...
            for (int b = 0; b < nb; b++) {
                // d4 0 1 2 3, 4 5 6 7
                float32x4_t q4_d_0     = vcvt_f32_f16(vld1_f16((const __fp16 *) q4_ptr[b].d));
                float32x4_t q4_d_1     = vcvt_f32_f16(vld1_f16((const __fp16 *) q4_ptr[b].d + 4));
                // d8 0 1 2 3
                float32x4_t q8_d       = vcvt_f32_f16(vld1_f16((const __fp16 *) q8_ptr[b].d));
                // mins
                float32x4_t q4_dmin_0  = vcvt_f32_f16(vld1_f16((const __fp16 *) q4_ptr[b].dmin));
                float32x4_t q4_dmin_1  = vcvt_f32_f16(vld1_f16((const __fp16 *) q4_ptr[b].dmin + 4));

                // TODO: precomputation of scales and mins
                float32x4_t sb_scale_0 = vmulq_f32(q4_d_0, q8_d);
                float32x4_t sb_scale_1 = vmulq_f32(q4_d_1, q8_d);
                float32x4_t sb_min_0   = vmulq_f32(q4_dmin_0, q8_d);
                float32x4_t sb_min_1   = vmulq_f32(q4_dmin_1, q8_d);
                ...
                // TODO: Comment on structure of acc
                int32x4_t acc_lo[acc_size];
                int32x4_t acc_hi[acc_size];
                // bias acc shares size, but rationale is different
                // interleaved bias_acc: [0]->r0 0123, [1]->r0 4567, [2]->r1 0123 ...
                ...
                for (int sb = 0; sb < QK_K / 64; sb++) {
                    ...
                    constexpr int reads_per_sb = 8; // 16 bytes each => 32 qs * 4 rows
                    for (int k = 0; k < reads_per_sb; k++) {
                        ...
                        // 0..3 & 32..35
                        const uint8x16_t q4_cp_0123 = vld1q_u8(q4_ptr[b].qs + sb * QK_K + 32 * k);
                        const uint8x16_t q4_cp_4567 = vld1q_u8(q4_ptr[b].qs + sb * QK_K + 32 * k + 16);

                        const int8x16_t q4_0123_lo = vreinterpretq_s8_u8(vandq_u8(q4_cp_0123, m4b));
                        const int8x16_t q4_0123_hi = vreinterpretq_s8_u8(vandq_u8(q4_cp_0123, m4b));

                        acc_lo[0] = vdotq_laneq_s32(acc_lo[0], q8_blk0, q4_0123_lo, 0); //  0..3  r0 c0123
                        acc_lo[1] = vdotq_laneq_s32(acc_lo[1], q8_blk0, q4_0123_lo, 1); //  0..3  r1 c0123
                        acc_lo[2] = vdotq_laneq_s32(acc_lo[2], q8_blk0, q4_0123_lo, 2); //  0..3  r2 c0123
                        acc_lo[3] = vdotq_laneq_s32(acc_lo[3], q8_blk0, q4_0123_lo, 3); //  0..3  r3 c0123

                        acc_hi[0] = vdotq_laneq_s32(acc_hi[0], q8_blk1, q4_0123_hi, 0); // 32..35 r0 c0123
                        acc_hi[1] = vdotq_laneq_s32(acc_hi[1], q8_blk1, q4_0123_hi, 1); // 32..35 r1 c0123
                        acc_hi[2] = vdotq_laneq_s32(acc_hi[2], q8_blk1, q4_0123_hi, 2); // 32..35 r2 c0123
                        acc_hi[3] = vdotq_laneq_s32(acc_hi[3], q8_blk1, q4_0123_hi, 3); // 32..35 r3 c0123

                        const uint8x16_t q4_4567_lo = vreinterpretq_s8_u8(vshrq_n_u8(q4_cp_4567, 4));
                        const uint8x16_t q4_4567_hi = vreinterpretq_s8_u8(vshrq_n_u8(q4_cp_4567, 4));

                        acc_lo[4] = vdotq_laneq_s32(acc_lo[4], q8_blk0, q4_4567_lo, 0); //  0..3  r0 c4567
                        acc_lo[5] = vdotq_laneq_s32(acc_lo[5], q8_blk0, q4_4567_lo, 1); //  0..3  r1 c4567
                        acc_lo[6] = vdotq_laneq_s32(acc_lo[6], q8_blk0, q4_4567_lo, 2); //  0..3  r2 c4567
                        acc_lo[7] = vdotq_laneq_s32(acc_lo[7], q8_blk0, q4_4567_lo, 3); //  0..3  r3 c4567

                        acc_lo[4] = vdotq_laneq_s32(acc_lo[4], q8_blk1, q4_4567_hi, 0); // 32..35 r0 c4567
                        acc_lo[5] = vdotq_laneq_s32(acc_lo[5], q8_blk1, q4_4567_hi, 1); // 32..35 r1 c4567
                        acc_lo[6] = vdotq_laneq_s32(acc_lo[6], q8_blk1, q4_4567_hi, 2); // 32..35 r2 c4567
                        acc_lo[7] = vdotq_laneq_s32(acc_lo[7], q8_blk1, q4_4567_hi, 3); // 32..35 r3 c4567
                    }

                    // TODO: Bias and scales

                    // Q4s columns iterated in quartets (0123, 4567)
                    for (int cp = 0; cp < ncols_interleaved / 4; cp++) {
