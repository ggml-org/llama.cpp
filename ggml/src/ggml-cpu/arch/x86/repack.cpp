...
void ggml_gemv_q5_K_8x8_q8_K(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, const void * GGML_RESTRICT vy, int nr, int nc) {
    ...
    // Pointers to LHS blocks of block_q8_K format
    const block_q8_K * a_ptr = a_ptr_start ;

    // Take group of eight interleaved block_q5_K structures at each pass of the loop and perform dot product operation
    for (int64_t x = 0; x < nc / 8; x++) {
        ...
        for (int64_t b = 0; b < nb; b++) {
            ...
            // Load the scale values for the 8 blocks interleaved in block_q5_Kx8
            // col_scale_f32 rearranged so as to multiply with appropriate quants
            const __m256 col_scale_f32 = GGML_F32Cx8_REARRANGE_LOAD(b_ptr[b].d, deltamask);
            const __m256 col_dmin_f32 = GGML_F32Cx8_LOAD(b_ptr[b].dmin);
            ...
            const __m256i rhs_raw_hbit_4567_1 = _mm256_loadu_si256((const __m256i *)(b_ptr[b].qh + 96));
            const __m256i rhs_raw_hbit_0123_2 = _mm256_loadu_si256((const __m256i *)(b_ptr[b].qh + 128));
            const __m256i rhs_raw_hbit_4567_2 = _mm256_loadu_si256((const __m256i *)(b_ptr[b].qh + 160));
            const __m256i rhs_raw_hbit_0123_3 = _mm256_loadu_si256((const __m256i *)(b_ptr[b].qh + 192));
            const __m256i rhs_raw_hbit_4567_3 = _mm256_loadu_si256((const __m256i *)(b_ptr[b].qh + 224));

            // Processes two sub blocks from each q5_K in each iteration
            for (int sb = 0; sb < QK_K / 64; sb++) {

                // Load the eight block_q5_K for two sub blocks quantized values interleaved with each other in chunks of eight - B0,B1 ....B6,B7
                const __m256i rhs_raw_lbit_0123_0 = _mm256_loadu_si256((const __m256i *)(b_ptr[b].qs + sb * 256));
                const __m256i rhs_raw_lbit_4567_0 = _mm256_loadu_si256((const __m256i *)(b_ptr[b].qs + 32 + sb * 256));
                const __m256i rhs_raw_lbit_0123_1 = _mm256_loadu_si256((const __m256i *)(b_ptr[b].qs + 64 + sb * 256));
                const __m256i rhs_raw_lbit_4567_1 = _mm256_loadu_si256((const __m256i *)(b_ptr[b].qs + 96 + sb * 256));
                const __m256i rhs_raw_lbit_0123_2 = _mm256_loadu_si256((const __m256i *)(b_ptr[b].qs + 128 + sb * 256));
                const __m256i rhs_raw_lbit_4567_2 = _mm256_loadu_si256((const __m256i *)(b_ptr[b].qs + 160 + sb * 256));
                const __m256i rhs_raw_lbit_0123_3 = _mm256_loadu_si256((const __m256i *)(b_ptr[b].qs + 192 + sb * 256));
                const __m256i rhs_raw_lbit_4567_3 = _mm256_loadu_si256((const __m256i *)(b_ptr[b].qs + 224 + sb * 256));

                // 4-bit -> 8-bit
                // First sub block of the two sub blocks processed in the iteration
                const __m256i rhs_lbit_0123_00 = _mm256_and_si256(rhs_raw_lbit_0123_0, m4b); //B00(0-7) B01(0-7) B04(0-7) B05(0-7)
                const __m256i rhs_lbit_4567_00 = _mm256_and_si256(rhs_raw_lbit_4567_0, m4b); //B02(0-7) B03(0-7) B06(0-7) B07(0-7)

                const __m256i rhs_lbit_0123_01 = _mm256_and_si256(rhs_raw_lbit_0123_1, m4b); //B00(8-15) B01(8-15) B04(8-15) B05(8-15)
                const __m256i rhs_lbit_4567_01 = _mm256_and_si256(rhs_raw_lbit_4567_1, m4b); //B02(8-15) B03(8-15) B06(8-15) B07(8-15)

                const __m256i rhs_lbit_0123_02 = _mm256_and_si256(rhs_raw_lbit_0123_2, m4b); //B00(16-23) B01(16-23) B04(16-23) B05(16-23)
                const __m256i rhs_lbit_4567_02 = _mm256_and_si256(rhs_raw_lbit_4567_2, m4b); //B02(16-23) B03(16-23) B06(16-23) B07(16-23)

                const __m256i rhs_lbit_0123_03 = _mm256_and_si256(rhs_raw_lbit_0123_3, m4b); //B00(24-31) B01(24-31) B04(24-31) B05(24-31)
                const __m256i rhs_lbit_4567_03 = _mm256_and_si256(rhs_raw_lbit_4567_3, m4b); //B02(24-31) B03(24-31) B06(24-31) B07(24-31)

                // Second sub block of the two sub blocks processed in the iteration
                const __m256i rhs_lbit_0123_10 = _mm256_and_si256(_mm256_srli_epi16(rhs_raw_lbit_0123_0, 4), m4b); //B10(0-7) B11(0-7) B14(0-7) B15(0-7)
                const __m256i rhs_lbit_4567_10 = _mm256_and_si256(_mm256_srli_epi16(rhs_raw_lbit_4567_0, 4), m4b); //B12(0-7) B13(0-7) B16(0-7) B17(0-7)

                const __m256i rhs_lbit_0123_11 = _mm256_and_si256(_mm256_srli_epi16(rhs_raw_lbit_0123_1, 4), m4b); //B10(8-15) B11(8-15) B14(8-15) B15(8-15)
                const __m256i rhs_lbit_4567_11 = _mm256_and_si256(_mm256_srli_epi16(rhs_raw_lbit_4567_1, 4), m4b); //B12(8-15) B13(8-15) B16(8-15) B17(8-15)

                const __m256i rhs_lbit_0123_12 = _mm256_and_si256(_mm256_srli_epi16(rhs_raw_lbit_0123_2, 4), m4b); //B10(16-23) B11(16-23) B14(16-23) B15(16-23)
                const __m256i rhs_lbit_4567_12 = _mm256_and_si256(_mm256_srli_epi16(rhs_raw_lbit_4567_2, 4), m4b); //B12(16-23) B13(16-23) B16(16-23) B17(16-23)

                const __m256i rhs_lbit_0123_13 = _mm256_and_si256(_mm256_srli_epi16(rhs_raw_lbit_0123_3, 4), m4b); //B10(24-31) B11(24-31) B14(24-31) B15(24-31)
                const __m256i rhs_lbit_4567_13 = _mm256_and_si256(_mm256_srli_epi16(rhs_raw_lbit_4567_3, 4), m4b); //B12(24-31) B13(24-31) B16(24-31) B17(24-31)

                const __m256i rhs_hbit_0123_00 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_0123_0, hmask), bit), 4);
                const __m256i rhs_hbit_4567_00 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_4567_0, hmask), bit), 4);

                const __m256i rhs_hbit_0123_01 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_0123_1, hmask), bit), 4);
                const __m256i rhs_hbit_4567_01 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_4567_1, hmask), bit), 4);

                const __m256i rhs_hbit_0123_02 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_0123_2, hmask), bit), 4);
                const __m256i rhs_hbit_4567_02 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_4567_2, hmask), bit), 4);
                ...
                const __m256i rhs_hbit_0123_10 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_0123_0, hmask), bit + 1), 4);
                const __m256i rhs_hbit_4567_10 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_4567_0, hmask), bit + 1), 4);

                const __m256i rhs_hbit_0123_11 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_0123_1, hmask), bit + 1), 4);
                const __m256i rhs_hbit_4567_11 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_4567_1, hmask), bit + 1), 4);

                const __m256i rhs_hbit_0123_12 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_0123_2, hmask), bit + 1), 4);
                const __m256i rhs_hbit_4567_12 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_4567_2, hmask), bit + 1), 4);

                const __m256i rhs_hbit_0123_13 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_0123_3, hmask), bit + 1), 4);
                const __m256i rhs_hbit_4567_13 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_4567_3, hmask), bit + 1), 4);
                ...
                // Broadcast the bsums of the two sub blocks  of the iteration of Q8_K across the vector
                // Multiply-Add with corresponding mins of q5_Kx8 with bsums
                __m256i q8s_sb = _mm256_shuffle_epi32(q8s, 0);
                __m256i iacc_min_sb = _mm256_madd_epi16(q8s_sb, mins_01);
                q8s = _mm256_bsrli_epi128(q8s, 4);
        ...
        // Accumulated output values permuted so as to be stored in appropriate order post accumulation
        acc_row = _mm256_permutevar8x32_ps(acc_row, finalpermutemask);
        _mm256_storeu_ps(s + (x * 8), _mm256_sub_ps(acc_row, acc_min_rows));
    }
...
void ggml_gemm_q5_K_8x8_q8_K(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, const void * GGML_RESTRICT vy, int nr, int nc) {
    ...
    int anc = nc - nc % 16; // Used to align nc with boundary of 16
    const __m512i mone_expanded = _mm512_set1_epi8(1);
    // Mask to mask out nibbles from packed bytes expanded to 512 bit length
    const __m512i m4bexpanded = _mm512_set1_epi8(0x0F);
    //Take group of four block_q8_Kx4 structures at each pass of the loop and perform dot product operation
    for (; y < anr / 4; y += 4) {
        ...
        for (int64_t x = 0; x < anc / 8; x += 2) {
            ...
            for (int64_t b = 0; b < nb; b++) {
                ...
                // Load the sixteen block_q5_k higher packed bits
                // They are blended/permuted for further mul mat operations within the pipeline
                const __m256i rhs_raw_hbit_0123_0 = _mm256_loadu_si256((const __m256i *)(b_ptr_0[b].qh));
                const __m256i rhs_raw_hbit_4567_0 = _mm256_loadu_si256((const __m256i *)(b_ptr_0[b].qh + 32));
                const __m256i rhs_raw_hbit_0123_1 = _mm256_loadu_si256((const __m256i *)(b_ptr_0[b].qh + 64));
                const __m256i rhs_raw_hbit_4567_1 = _mm256_loadu_si256((const __m256i *)(b_ptr_0[b].qh + 96));
                const __m256i rhs_raw_hbit_0123_2 = _mm256_loadu_si256((const __m256i *)(b_ptr_0[b].qh + 128));
                const __m256i rhs_raw_hbit_4567_2 = _mm256_loadu_si256((const __m256i *)(b_ptr_0[b].qh + 160));
                const __m256i rhs_raw_hbit_0123_3 = _mm256_loadu_si256((const __m256i *)(b_ptr_0[b].qh + 192));
                const __m256i rhs_raw_hbit_4567_3 = _mm256_loadu_si256((const __m256i *)(b_ptr_0[b].qh + 224));

                const __m256i rhs_raw_hbit_89AB_0 = _mm256_loadu_si256((const __m256i *)(b_ptr_1[b].qh));
                const __m256i rhs_raw_hbit_CDEF_0 = _mm256_loadu_si256((const __m256i *)(b_ptr_1[b].qh + 32));
                const __m256i rhs_raw_hbit_89AB_1 = _mm256_loadu_si256((const __m256i *)(b_ptr_1[b].qh + 64));
                const __m256i rhs_raw_hbit_CDEF_1 = _mm256_loadu_si256((const __m256i *)(b_ptr_1[b].qh + 96));
                const __m256i rhs_raw_hbit_89AB_2 = _mm256_loadu_si256((const __m256i *)(b_ptr_1[b].qh + 128));
                const __m256i rhs_raw_hbit_CDEF_2 = _mm256_loadu_si256((const __m256i *)(b_ptr_1[b].qh + 160));
                const __m256i rhs_raw_hbit_89AB_3 = _mm256_loadu_si256((const __m256i *)(b_ptr_1[b].qh + 192));
                const __m256i rhs_raw_hbit_CDEF_3 = _mm256_loadu_si256((const __m256i *)(b_ptr_1[b].qh + 224));
                ...
                for (int sb = 0; sb < QK_K / 64; sb++) {
                    ...
                    const __m256i rhs_raw_lbit_0123_1 = _mm256_loadu_si256((const __m256i * )(b_ptr_0[b].qs + 64 + sb * 256));
                    const __m256i rhs_raw_lbit_4567_1 = _mm256_loadu_si256((const __m256i * )(b_ptr_0[b].qs + 96 + sb * 256));
                    const __m256i rhs_raw_lbit_0123_2 = _mm256_loadu_si256((const __m256i * )(b_ptr_0[b].qs + 128 + sb * 256));
                    const __m256i rhs_raw_lbit_4567_2 = _mm256_loadu_si256((const __m256i * )(b_ptr_0[b].qs + 160 + sb * 256));
                    const __m256i rhs_raw_lbit_0123_3 = _mm256_loadu_si256((const __m256i * )(b_ptr_0[b].qs + 192 + sb * 256));
                    const __m256i rhs_raw_lbit_4567_3 = _mm256_loadu_si256((const __m256i * )(b_ptr_0[b].qs + 224 + sb * 256));

                    const __m256i rhs_raw_lbit_89AB_0 = _mm256_loadu_si256((const __m256i * )(b_ptr_1[b].qs + sb * 256));
                    const __m256i rhs_raw_lbit_CDEF_0 = _mm256_loadu_si256((const __m256i * )(b_ptr_1[b].qs + 32 + sb * 256));
                    const __m256i rhs_raw_lbit_89AB_1 = _mm256_loadu_si256((const __m256i * )(b_ptr_1[b].qs + 64 + sb * 256));
                    const __m256i rhs_raw_lbit_CDEF_1 = _mm256_loadu_si256((const __m256i * )(b_ptr_1[b].qs + 96 + sb * 256));
                    const __m256i rhs_raw_lbit_89AB_2 = _mm256_loadu_si256((const __m256i * )(b_ptr_1[b].qs + 128 + sb * 256));
                    const __m256i rhs_raw_lbit_CDEF_2 = _mm256_loadu_si256((const __m256i * )(b_ptr_1[b].qs + 160 + sb * 256));
                    const __m256i rhs_raw_lbit_89AB_3 = _mm256_loadu_si256((const __m256i * )(b_ptr_1[b].qs + 192 + sb * 256));
                    const __m256i rhs_raw_lbit_CDEF_3 = _mm256_loadu_si256((const __m256i * )(b_ptr_1[b].qs + 224 + sb * 256));
                    ...
                    const __m256i rhs_raw_lbit_0145_2 = _mm256_blend_epi32(rhs_raw_lbit_0123_2, _mm256_permutevar8x32_epi32(rhs_raw_lbit_4567_2, requiredOrder), 240);
                    const __m256i rhs_raw_lbit_2367_2 = _mm256_blend_epi32(_mm256_permutevar8x32_epi32(rhs_raw_lbit_0123_2, requiredOrder), rhs_raw_lbit_4567_2, 240);
                    const __m256i rhs_raw_lbit_0145_3 = _mm256_blend_epi32(rhs_raw_lbit_0123_3, _mm256_permutevar8x32_epi32(rhs_raw_lbit_4567_3, requiredOrder), 240);
                    const __m256i rhs_raw_lbit_2367_3 = _mm256_blend_epi32(_mm256_permutevar8x32_epi32(rhs_raw_lbit_0123_3, requiredOrder), rhs_raw_lbit_4567_3, 240);
                    ...
                    const __m256i rhs_raw_lbit_89CD_2 = _mm256_blend_epi32(rhs_raw_lbit_89AB_2, _mm256_permutevar8x32_epi32(rhs_raw_lbit_CDEF_2, requiredOrder), 240);
                    const __m256i rhs_raw_lbit_ABEF_2 = _mm256_blend_epi32(_mm256_permutevar8x32_epi32(rhs_raw_lbit_89AB_2, requiredOrder), rhs_raw_lbit_CDEF_2, 240);
                    const __m256i rhs_raw_lbit_89CD_3 = _mm256_blend_epi32(rhs_raw_lbit_89AB_3, _mm256_permutevar8x32_epi32(rhs_raw_lbit_CDEF_3, requiredOrder), 240);
                    const __m256i rhs_raw_lbit_ABEF_3 = _mm256_blend_epi32(_mm256_permutevar8x32_epi32(rhs_raw_lbit_89AB_3, requiredOrder), rhs_raw_lbit_CDEF_3, 240);
                    ...
                    const __m512i rhs_raw_lbit_014589CD_2 = _mm512_inserti32x8(_mm512_castsi256_si512(rhs_raw_lbit_0145_2), rhs_raw_lbit_89CD_2, 1);
                    const __m512i rhs_raw_lbit_2367ABEF_2 = _mm512_inserti32x8(_mm512_castsi256_si512(rhs_raw_lbit_2367_2), rhs_raw_lbit_ABEF_2, 1);
                    const __m512i rhs_raw_lbit_014589CD_3 = _mm512_inserti32x8(_mm512_castsi256_si512(rhs_raw_lbit_0145_3), rhs_raw_lbit_89CD_3, 1);
                    const __m512i rhs_raw_lbit_2367ABEF_3 = _mm512_inserti32x8(_mm512_castsi256_si512(rhs_raw_lbit_2367_3), rhs_raw_lbit_ABEF_3, 1);

                    //4-bit -> 8-bit
                    const __m512i rhs_lbit_014589CD_00 = _mm512_and_si512(rhs_raw_lbit_014589CD_0, m4bexpanded); //B00(0-7) B01(0-7) B04(0-7) B05(0-7) B08(0-7) B09(0-7) B0C(0-7) B0D(0-7)
                    const __m512i rhs_lbit_2367ABEF_00 = _mm512_and_si512(rhs_raw_lbit_2367ABEF_0, m4bexpanded); //B02(0-7) B03(0-7) B06(0-7) B07(0-7) B0A(0-7) B0B(0-7) B0E(0-7) B0F(0-7)
                    const __m512i rhs_lbit_014589CD_01 = _mm512_and_si512(rhs_raw_lbit_014589CD_1, m4bexpanded); //B00(8-15) B01(8-15) B04(8-15) B05(8-15) B08(8-15) B09(8-15) B0C(8-15) B0D(8-15)
                    const __m512i rhs_lbit_2367ABEF_01 = _mm512_and_si512(rhs_raw_lbit_2367ABEF_1, m4bexpanded); //B02(8-15) B03(8-15) B06(8-15) B07(8-15) B0A(8-15) B0B(8-15) B0E(8-15) B0F(8-15)

                    const __m512i rhs_lbit_014589CD_02 = _mm512_and_si512(rhs_raw_lbit_014589CD_2, m4bexpanded); //B00(16-23) B01(16-23) B04(16-23) B05(16-23) B08(16-23) B09(16-23) B0C(16-23) B0D(16-23)
                    const __m512i rhs_lbit_2367ABEF_02 = _mm512_and_si512(rhs_raw_lbit_2367ABEF_2, m4bexpanded); //B02(16-23) B03(16-23) B06(16-23) B07(16-23) B0A(16-23) B0B(16-23) B0E(16-23) B0F(16-23)
                    const __m512i rhs_lbit_014589CD_03 = _mm512_and_si512(rhs_raw_lbit_014589CD_3, m4bexpanded); //B00(24-31) B01(24-31) B04(24-31) B05(24-31) B08(24-31) B09(24-31) B0C(24-31) B0D(24-31)
                    const __m512i rhs_lbit_2367ABEF_03 = _mm512_and_si512(rhs_raw_lbit_2367ABEF_3, m4bexpanded); //B02(24-31) B03(24-31) B06(24-31) B07(24-31) B0A(24-31) B0B(24-31) B0E(24-31) B0F(24-31)

                    const __m512i rhs_hbit_014589CD_00 =  _mm512_slli_epi16(_mm512_srli_epi16(_mm512_and_si512(rhs_raw_hbit_014589CD_0, hmask_expanded), bit), 4);
                    const __m512i rhs_hbit_2367ABEF_00 =  _mm512_slli_epi16(_mm512_srli_epi16(_mm512_and_si512(rhs_raw_hbit_2367ABEF_0, hmask_expanded), bit), 4);

                    const __m512i rhs_hbit_014589CD_01 =  _mm512_slli_epi16(_mm512_srli_epi16(_mm512_and_si512(rhs_raw_hbit_014589CD_1, hmask_expanded), bit), 4);
                    const __m512i rhs_hbit_2367ABEF_01 =  _mm512_slli_epi16(_mm512_srli_epi16(_mm512_and_si512(rhs_raw_hbit_2367ABEF_1, hmask_expanded), bit), 4);

                    const __m512i rhs_hbit_014589CD_02 =  _mm512_slli_epi16(_mm512_srli_epi16(_mm512_and_si512(rhs_raw_hbit_014589CD_2, hmask_expanded), bit), 4);
                    const __m512i rhs_hbit_2367ABEF_02 =  _mm512_slli_epi16(_mm512_srli_epi16(_mm512_and_si512(rhs_raw_hbit_2367ABEF_2, hmask_expanded), bit), 4);

                    const __m512i rhs_hbit_014589CD_03 =  _mm512_slli_epi16(_mm512_srli_epi16(_mm512_and_si512(rhs_raw_hbit_014589CD_3, hmask_expanded), bit), 4);
                    const __m512i rhs_hbit_2367ABEF_03 =  _mm512_slli_epi16(_mm512_srli_epi16(_mm512_and_si512(rhs_raw_hbit_2367ABEF_3, hmask_expanded), bit), 4);
                    ...
                    const __m512i rhs_lbit_014589CD_10 = _mm512_and_si512(_mm512_srli_epi16(rhs_raw_lbit_014589CD_0, 4), m4bexpanded); //B10(0-7) B11(0-7) B14(0-7) B15(0-7) B18(0-7) B19(0-7) B1C(0-7) B1D(0-7)
                    const __m512i rhs_lbit_2367ABEF_10 = _mm512_and_si512(_mm512_srli_epi16(rhs_raw_lbit_2367ABEF_0, 4), m4bexpanded); //B12(0-7) B13(0-7) B16(0-7) B17(0-7) B1A(0-7) B1B(0-7) B1E(0-7) B1F(0-7)
                    const __m512i rhs_lbit_014589CD_11 = _mm512_and_si512(_mm512_srli_epi16(rhs_raw_lbit_014589CD_1, 4), m4bexpanded); //B10(8-15) B11(8-15) B14(8-15) B15(8-15) B18(8-15) B19(8-15) B1C(8-15) B1D(8-15)
                    const __m512i rhs_lbit_2367ABEF_11 = _mm512_and_si512(_mm512_srli_epi16(rhs_raw_lbit_2367ABEF_1, 4), m4bexpanded); //B12(8-15) B13(8-15) B16(8-15) B17(8-15) B1A(8-15) B1B(8-15) B1E(8-15) B1F(8-15)

                    const __m512i rhs_lbit_014589CD_12 = _mm512_and_si512(_mm512_srli_epi16(rhs_raw_lbit_014589CD_2, 4), m4bexpanded); //B10(16-23) B11(16-23) B14(16-23) B15(16-23) B18(16-23) B19(16-23) B1C(16-23) B1D(16-23)
                    const __m512i rhs_lbit_2367ABEF_12 = _mm512_and_si512(_mm512_srli_epi16(rhs_raw_lbit_2367ABEF_2, 4), m4bexpanded); //B12(16-23) B13(16-23) B16(16-23) B17(16-23) B1A(16-23) B1B(16-23) B1E(16-23) B1F(16-23)
                    const __m512i rhs_lbit_014589CD_13 = _mm512_and_si512(_mm512_srli_epi16(rhs_raw_lbit_014589CD_3, 4), m4bexpanded); //B10(24-31) B11(24-31) B14(24-31) B15(24-31) B18(24-31) B19(24-31) B1C(24-31) B1D(24-31)
                    const __m512i rhs_lbit_2367ABEF_13 = _mm512_and_si512(_mm512_srli_epi16(rhs_raw_lbit_2367ABEF_3, 4), m4bexpanded); //B12(24-31) B13(24-31) B16(24-31) B17(24-31) B1A(24-31) B1B(24-31) B1E(24-31) B1F(24-31)

                    const __m512i rhs_hbit_014589CD_10 =  _mm512_slli_epi16(_mm512_srli_epi16(_mm512_and_si512(rhs_raw_hbit_014589CD_0, hmask_expanded), bit), 4);
                    const __m512i rhs_hbit_2367ABEF_10 =  _mm512_slli_epi16(_mm512_srli_epi16(_mm512_and_si512(rhs_raw_hbit_2367ABEF_0, hmask_expanded), bit), 4);

                    const __m512i rhs_hbit_014589CD_11 =  _mm512_slli_epi16(_mm512_srli_epi16(_mm512_and_si512(rhs_raw_hbit_014589CD_1, hmask_expanded), bit), 4);
                    const __m512i rhs_hbit_2367ABEF_11 =  _mm512_slli_epi16(_mm512_srli_epi16(_mm512_and_si512(rhs_raw_hbit_2367ABEF_1, hmask_expanded), bit), 4);

                    const __m512i rhs_hbit_014589CD_12 =  _mm512_slli_epi16(_mm512_srli_epi16(_mm512_and_si512(rhs_raw_hbit_014589CD_2, hmask_expanded), bit), 4);
                    const __m512i rhs_hbit_2367ABEF_12 =  _mm512_slli_epi16(_mm512_srli_epi16(_mm512_and_si512(rhs_raw_hbit_2367ABEF_2, hmask_expanded), bit), 4);

                    const __m512i rhs_hbit_014589CD_13 =  _mm512_slli_epi16(_mm512_srli_epi16(_mm512_and_si512(rhs_raw_hbit_014589CD_3, hmask_expanded), bit), 4);
                    const __m512i rhs_hbit_2367ABEF_13 =  _mm512_slli_epi16(_mm512_srli_epi16(_mm512_and_si512(rhs_raw_hbit_2367ABEF_3, hmask_expanded), bit), 4);

                    ++bit;

                    const __m512i rhs_mat_014589CD_10 = _mm512_add_epi8(rhs_lbit_014589CD_10,rhs_hbit_014589CD_10);
                    const __m512i rhs_mat_2367ABEF_10 = _mm512_add_epi8(rhs_lbit_2367ABEF_10,rhs_hbit_2367ABEF_10);

                    const __m512i rhs_mat_014589CD_11 = _mm512_add_epi8(rhs_lbit_014589CD_11,rhs_hbit_014589CD_11);
                    const __m512i rhs_mat_2367ABEF_11 = _mm512_add_epi8(rhs_lbit_2367ABEF_11,rhs_hbit_2367ABEF_11);

                    const __m512i rhs_mat_014589CD_12 = _mm512_add_epi8(rhs_lbit_014589CD_12,rhs_hbit_014589CD_12);
                    const __m512i rhs_mat_2367ABEF_12 = _mm512_add_epi8(rhs_lbit_2367ABEF_12,rhs_hbit_2367ABEF_12);

                    const __m512i rhs_mat_014589CD_13 = _mm512_add_epi8(rhs_lbit_014589CD_13,rhs_hbit_014589CD_13);
                    const __m512i rhs_mat_2367ABEF_13 = _mm512_add_epi8(rhs_lbit_2367ABEF_13,rhs_hbit_2367ABEF_13);
    ...
    for (; y < anr / 4; y += 4) {
        ...
        for (int64_t x = xstart; x < nc / 8; x++) {
            ...
            // For super block
            for (int64_t b = 0; b < nb; b++) {
                // Scale values - Load the eight scale values of block_q5_kx8
                const __m256 col_scale_f32 = GGML_F32Cx8_LOAD(b_ptr[b].d);
                ...
                for (int sb = 0; sb < QK_K / 64; sb++)  {
                    ...
                    // Load the eight block_q5_k for eight sub blocks quantized values interleaved with each other in chunks of eight bytes - B0,B1 ....B6,B7
                    // The lower and higher packed bits are loaded, unpacked and individual bytes representing 6 bits each are formed from the same
                    // They are blended/permuted for further mul mat operations within the pipeline
                    const __m256i rhs_raw_lbit_0123_0 = _mm256_loadu_si256((const __m256i *)(b_ptr[b].qs + sb * 256));
                    const __m256i rhs_raw_lbit_4567_0 = _mm256_loadu_si256((const __m256i *)(b_ptr[b].qs + 32 + sb * 256));
                    const __m256i rhs_raw_lbit_0123_1 = _mm256_loadu_si256((const __m256i *)(b_ptr[b].qs + 64 + sb * 256));
                    ...
                    // 4-bit -> 8-bit
                    // First sub block of the two sub blocks processed in the iteration
                    const __m256i rhs_lbit_0145_00 = _mm256_and_si256(rhs_raw_lbit_0145_0, m4b); //B00(0-7) B01(0-7) B04(0-7) B05(0-7)
                    const __m256i rhs_lbit_2367_00 = _mm256_and_si256(rhs_raw_lbit_2367_0, m4b); //B02(0-7) B03(0-7) B06(0-7) B07(0-7)

                    const __m256i rhs_lbit_0145_01 = _mm256_and_si256(rhs_raw_lbit_0145_1, m4b); //B00(8-15) B01(8-15) B04(8-15) B05(8-15)
                    const __m256i rhs_lbit_2367_01 = _mm256_and_si256(rhs_raw_lbit_2367_1, m4b); //B02(8-15) B03(8-15) B06(8-15) B07(8-15)

                    const __m256i rhs_lbit_0145_02 = _mm256_and_si256(rhs_raw_lbit_0145_2, m4b); //B00(16-23) B01(16-23) B04(16-23) B05(16-23)
                    const __m256i rhs_lbit_2367_02 = _mm256_and_si256(rhs_raw_lbit_2367_2, m4b); //B02(16-23) B03(16-23) B06(16-23) B07(16-23)

                    const __m256i rhs_lbit_0145_03 = _mm256_and_si256(rhs_raw_lbit_0145_3, m4b); //B00(24-31) B01(24-31) B04(24-31) B05(24-31)
                    const __m256i rhs_lbit_2367_03 = _mm256_and_si256(rhs_raw_lbit_2367_3, m4b); //B02(24-31) B03(24-31) B06(24-31) B07(24-31)

                    // Second sub block of the two sub blocks processed in the iteration
                    const __m256i rhs_lbit_0145_10 = _mm256_and_si256(_mm256_srli_epi16(rhs_raw_lbit_0145_0, 4), m4b); //B10(0-7) B11(0-7) B14(0-7) B15(0-7)
                    const __m256i rhs_lbit_2367_10 = _mm256_and_si256(_mm256_srli_epi16(rhs_raw_lbit_2367_0, 4), m4b); //B12(0-7) B13(0-7) B16(0-7) B17(0-7)

                    const __m256i rhs_lbit_0145_11 = _mm256_and_si256(_mm256_srli_epi16(rhs_raw_lbit_0145_1, 4), m4b); //B10(8-15) B11(8-15) B14(8-15) B15(8-15)
                    const __m256i rhs_lbit_2367_11 = _mm256_and_si256(_mm256_srli_epi16(rhs_raw_lbit_2367_1, 4), m4b); //B12(8-15) B13(8-15) B16(8-15) B17(8-15)

                    const __m256i rhs_lbit_0145_12 = _mm256_and_si256(_mm256_srli_epi16(rhs_raw_lbit_0145_2, 4), m4b); //B10(16-23) B11(16-23) B14(16-23) B15(16-23)
                    const __m256i rhs_lbit_2367_12 = _mm256_and_si256(_mm256_srli_epi16(rhs_raw_lbit_2367_2, 4), m4b); //B12(16-23) B13(16-23) B16(16-23) B17(16-23)

                    const __m256i rhs_lbit_0145_13 = _mm256_and_si256(_mm256_srli_epi16(rhs_raw_lbit_0145_3, 4), m4b); //B10(24-31) B11(24-31) B14(24-31) B15(24-31)
                    const __m256i rhs_lbit_2367_13 = _mm256_and_si256(_mm256_srli_epi16(rhs_raw_lbit_2367_3, 4), m4b); //B12(24-31) B13(24-31) B16(24-31) B17(24-31)

                    const __m256i rhs_hbit_0145_00 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_0145_0, hmask), bit), 4);
                    const __m256i rhs_hbit_2367_00 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_2367_0, hmask), bit), 4);

                    const __m256i rhs_hbit_0145_01 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_0145_1, hmask), bit), 4);
                    const __m256i rhs_hbit_2367_01 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_2367_1, hmask), bit), 4);

                    const __m256i rhs_hbit_0145_02 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_0145_2, hmask), bit), 4);
                    const __m256i rhs_hbit_2367_02 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_2367_2, hmask), bit), 4);

                    const __m256i rhs_hbit_0145_03 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_0145_3, hmask), bit), 4);
                    const __m256i rhs_hbit_2367_03 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_2367_3, hmask), bit), 4);

                    ++bit;

                    const __m256i rhs_mat_0145_00 = _mm256_add_epi8(rhs_lbit_0145_00,rhs_hbit_0145_00);
                    const __m256i rhs_mat_2367_00 = _mm256_add_epi8(rhs_lbit_2367_00,rhs_hbit_2367_00);

                    const __m256i rhs_mat_0145_01 = _mm256_add_epi8(rhs_lbit_0145_01,rhs_hbit_0145_01);
                    const __m256i rhs_mat_2367_01 = _mm256_add_epi8(rhs_lbit_2367_01,rhs_hbit_2367_01);

                    const __m256i rhs_mat_0145_02 = _mm256_add_epi8(rhs_lbit_0145_02,rhs_hbit_0145_02);
                    const __m256i rhs_mat_2367_02 = _mm256_add_epi8(rhs_lbit_2367_02,rhs_hbit_2367_02);

                    const __m256i rhs_mat_0145_03 = _mm256_add_epi8(rhs_lbit_0145_03,rhs_hbit_0145_03);
                    const __m256i rhs_mat_2367_03 = _mm256_add_epi8(rhs_lbit_2367_03,rhs_hbit_2367_03);

                    hmask = _mm256_slli_epi16(hmask, 1);

                    const __m256i rhs_hbit_0145_10 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_0145_0, hmask), bit), 4);
                    const __m256i rhs_hbit_2367_10 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_2367_0, hmask), bit), 4);

                    const __m256i rhs_hbit_0145_11 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_0145_1, hmask), bit), 4);
                    const __m256i rhs_hbit_2367_11 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_2367_1, hmask), bit), 4);

                    const __m256i rhs_hbit_0145_12 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_0145_2, hmask), bit), 4);
                    const __m256i rhs_hbit_2367_12 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_2367_2, hmask), bit), 4);

                    const __m256i rhs_hbit_0145_13 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_0145_3, hmask), bit), 4);
                    const __m256i rhs_hbit_2367_13 =  _mm256_slli_epi16(_mm256_srli_epi16(_mm256_and_si256(rhs_raw_hbit_2367_3, hmask), bit), 4);
