...
void ggml_compute_forward_tc4_hc_comb(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_tc4_hc_pre(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_tc4_hc_post(const struct ggml_compute_params * params, struct ggml_tensor * dst);
