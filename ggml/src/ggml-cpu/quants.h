...
void quantize_row_q2_K_blue(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
void quantize_row_q3_K_blue(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
