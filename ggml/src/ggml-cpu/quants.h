...
void quantize_row_q4_t(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
...
void ggml_vec_dot_q4_t_q8_0(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
