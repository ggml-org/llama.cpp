...
// ABI guard for ggml_tensor layout changes (bump when struct layout changes).
...
GGML_API struct ggml_tensor * ggml_set_rows_paged(struct ggml_context * ctx,
...
GGML_API void ggml_flash_attn_ext_set_seq_ids(struct ggml_tensor * a,
...
GGML_API void ggml_flash_attn_ext_set_paged(struct ggml_tensor * a,
...
GGML_API void ggml_flash_attn_ext_set_paged_layout(struct ggml_tensor * a, bool use_paged_layout);
...
GGML_API struct ggml_tensor * ggml_all_reduce_sum(struct ggml_context * ctx, struct ggml_tensor * a);
