...
extern "C" {
    ...
    */
    ...
    // TeleChat4 hyper-connections (DeepSeek-V2 MLA + 4-stream MHC). Same shape
    ...
    GGML_API struct ggml_tensor * ggml_tc4_hc_comb(
            struct ggml_context * ctx,
            struct ggml_tensor  * mixes,
            struct ggml_tensor  * scale,
            struct ggml_tensor  * base,
    ...
    GGML_API struct ggml_tensor * ggml_tc4_hc_pre(
            struct ggml_context * ctx,
            struct ggml_tensor  * x,
            struct ggml_tensor  * weights);

    GGML_API struct ggml_tensor * ggml_tc4_hc_post(
            struct ggml_context * ctx,
            struct ggml_tensor  * x,
            struct ggml_tensor  * residual,
            struct ggml_tensor  * post,
