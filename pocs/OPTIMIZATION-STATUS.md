...
| gfx1030 TP4 greedy speculative target sampling | Automatic backend target sampling for exact structural MTP `n_max=4` and DFlash `n_max=7`, large-vocabulary, neutral temperature-zero cases; explicit request choice and auto-disable paths are preserved | MTP A/B/B/A: `65.7854 -> 75.9478 tok/s` (**+15.45%**), cycle `45.345 -> 39.356 ms`. DFlash2 A/B/B/A: `62.3902 -> 69.7006 tok/s` (**+11.72%**), cycle `62.880 -> 56.285 ms`. Exact output/acceptance; long-output, prompt-cache, varied-prompt stress, graph/fallback, and parallel-slot checks passed. Q4_0 target verified; mechanism is quant-independent. Evidence: `/home/edwin/.ralph/speculative-mtp-target-backend-production-abba-20260821T211038Z` and `/home/edwin/.ralph/speculative-dflash2-greedy-auto-abba-20260821T213628Z`. |
