...
// TTY color auto-detect. Implementation moved here from common.cpp so
// this library (llama-log) is self-contained and does not have to link
// against llama-common. The declaration is also kept in common.h for
// backward compatibility with TUs that include only common.h.
