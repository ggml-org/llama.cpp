...
struct llama_model_params common_model_params_to_llama(common_params & params) {
    ...
    // load the MTP/NextN weights when speculative decoding will run the draft head,
    // or when imatrix collection has been asked to activate it (--mtp)
    mparams.load_mtp                    = params.imat_mtp ||
