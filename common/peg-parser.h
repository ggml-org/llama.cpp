...
struct common_peg_input {
    ...
    // append a chunk of text generated by chunk_tokens, where chunk_pos[i] is where the piece of chunk_tokens[i]
    // starts in the chunk, and only records special tokens whose whole text is in the chunk
