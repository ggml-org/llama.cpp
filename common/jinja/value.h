...
struct value_t {
    ...
    virtual const std::vector<std::pair<std::string, value>> & as_object() const { throw std::runtime_error(type() + " is not an object value"); }
...
struct value_object_t : public value_t {
    ...
    virtual const std::vector<std::pair<std::string, value>> & as_object() const override { return val_obj.ordered; }
    virtual bool as_bool() const override {
