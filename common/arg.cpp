...
void common_params_handle_models(common_params & params, llama_example curr_ex) {
    ...
    auto res = common_params_handle_model(params.model, params.hf_token, params.offline, spec_type_draft_mtp, params.hf_prune_old_files);
    if (params.no_mmproj) {
        params.mmproj = {};
    ...
    for (const auto & ex : mmproj_examples) {
        if (curr_ex == ex) {
            common_params_handle_model(params.mmproj,    params.hf_token, params.offline, false, params.hf_prune_old_files);
            break;
        }
    }
    ...
    common_params_handle_model(params.speculative.draft.mparams, params.hf_token, params.offline, false, params.hf_prune_old_files);
    common_params_handle_model(params.vocoder.model,             params.hf_token, params.offline, false, params.hf_prune_old_files);
}
