...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(common_arg(
        ...
        "available options:\n"
        "  'docker:<image>', 'podman:<image>', 'apptainer:<image>: spin up a new container and reuse it for all invocations, clean up on server exit\n"
        "  'docker-container:<id>', 'podman-container:<id>', 'apptainer-instance:<name>': use an existing container by ID/name, won't stop on server exit\n"
