...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(common_arg(
        ...
        "- mmap-ondemand: mmap, but read the pages on demand instead of prefetching the whole model\n"
        ...
        [](common_params & params, const std::string & value) {
            ...
            else if (value == "mmap-ondemand") { params.load_mode = LLAMA_LOAD_MODE_MMAP_ONDEMAND; }
