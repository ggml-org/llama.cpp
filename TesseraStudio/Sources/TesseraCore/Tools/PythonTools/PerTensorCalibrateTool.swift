...
/// Tessera `per_tensor_calibrate.py` wrapped as a `TesseraTool`.
public struct PerTensorCalibrateTool: TesseraTool, Sendable {
    public let tool: PythonTool

    public init() {
        // swiftlint:disable:next force_try
        self.tool = try! PythonTool(scriptName: "per_tensor_calibrate")
    }
