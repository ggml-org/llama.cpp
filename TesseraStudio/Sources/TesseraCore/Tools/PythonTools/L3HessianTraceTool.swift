...
/// Tessera `l3_hessian_trace.py` wrapped as a `TesseraTool`.
public struct L3HessianTraceTool: TesseraTool, Sendable {
    public let tool: PythonTool

    public init() {
        // swiftlint:disable:next force_try
        self.tool = try! PythonTool(scriptName: "l3_hessian_trace")
    }
