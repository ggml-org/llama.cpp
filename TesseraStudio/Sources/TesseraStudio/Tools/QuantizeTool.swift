...
struct QuantizeTool: TesseraTool {
    let name = "quantize"
    let description = "Quantize a GGUF model using a Tessera calibration policy. Produces a Tessera-quantized GGUF with per-tensor policy embedded in metadata."
