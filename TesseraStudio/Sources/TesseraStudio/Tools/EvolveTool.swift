...
struct EvolveTool: TesseraTool {
    let name = "evolve"
    let description = "Run AWQ-evolve genetic search to find the optimal per-tensor quantization policy given an imatrix and target bit budget."
