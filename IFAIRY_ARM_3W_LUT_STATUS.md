...
| 2025-12-18T03:55:08Z | `HEAD` | Apple M4 | 4 | 256 | `GGML_IFAIRY_LUT=1 GGML_IFAIRY_LUT_BK_BLOCKS=0 GGML_IFAIRY_LUT_BM=0 GGML_IFAIRY_LUT_FULLACC=0 GGML_IFAIRY_LUT_LAYOUT=legacy` | 7.01 |
...
| 2025-12-18T05:44:47Z | `1e1177a9` | Apple M4 | 4 | 256 | `GGML_IFAIRY_LUT=1 GGML_IFAIRY_LUT_BK_BLOCKS=0 GGML_IFAIRY_LUT_BM=0 GGML_IFAIRY_LUT_FULLACC=0 GGML_IFAIRY_LUT_LAYOUT=legacy` | 14.99 |
| 2025-12-18T05:45:07Z | `1e1177a9` | Apple M4 | 4 | 256 | `GGML_IFAIRY_LUT=1 GGML_IFAIRY_LUT_BK_BLOCKS=0 GGML_IFAIRY_LUT_BM=0 GGML_IFAIRY_LUT_FULLACC=0 GGML_IFAIRY_LUT_LAYOUT=legacy` | 14.53 |
| 2025-12-18T05:45:28Z | `1e1177a9` | Apple M4 | 4 | 256 | `GGML_IFAIRY_LUT=1 GGML_IFAIRY_LUT_BK_BLOCKS=0 GGML_IFAIRY_LUT_BM=0 GGML_IFAIRY_LUT_FULLACC=0 GGML_IFAIRY_LUT_LAYOUT=legacy` | 14.23 |
| 2025-12-18T05:45:50Z | `1e1177a9` | Apple M4 | 4 | 256 | `GGML_IFAIRY_LUT=1 GGML_IFAIRY_LUT_BK_BLOCKS=0 GGML_IFAIRY_LUT_BM=0 GGML_IFAIRY_LUT_FULLACC=0 GGML_IFAIRY_LUT_LAYOUT=compact` | 14.10 |
| 2025-12-18T05:46:11Z | `1e1177a9` | Apple M4 | 4 | 256 | `GGML_IFAIRY_LUT=1 GGML_IFAIRY_LUT_BK_BLOCKS=0 GGML_IFAIRY_LUT_BM=0 GGML_IFAIRY_LUT_FULLACC=0 GGML_IFAIRY_LUT_LAYOUT=compact` | 13.34 |
| 2025-12-18T05:46:34Z | `1e1177a9` | Apple M4 | 4 | 256 | `GGML_IFAIRY_LUT=1 GGML_IFAIRY_LUT_BK_BLOCKS=0 GGML_IFAIRY_LUT_BM=0 GGML_IFAIRY_LUT_FULLACC=0 GGML_IFAIRY_LUT_LAYOUT=compact` | 12.14 |
| 2025-12-18T05:50:34Z | `HEAD` | Apple M4 | 4 | 256 | `GGML_IFAIRY_LUT=1 GGML_IFAIRY_LUT_BK_BLOCKS=0 GGML_IFAIRY_LUT_BM=0 GGML_IFAIRY_LUT_FULLACC=0 GGML_IFAIRY_LUT_LAYOUT=compact GGML_IFAIRY_LUT_N1_FASTPATH=1` | 13.65 |
| 2025-12-18T05:50:57Z | `HEAD` | Apple M4 | 4 | 256 | `GGML_IFAIRY_LUT=1 GGML_IFAIRY_LUT_BK_BLOCKS=0 GGML_IFAIRY_LUT_BM=0 GGML_IFAIRY_LUT_FULLACC=0 GGML_IFAIRY_LUT_LAYOUT=compact GGML_IFAIRY_LUT_N1_FASTPATH=0` | 12.48 |
| 2025-12-18T05:51:21Z | `HEAD` | Apple M4 | 4 | 256 | `GGML_IFAIRY_LUT=1 GGML_IFAIRY_LUT_BK_BLOCKS=0 GGML_IFAIRY_LUT_BM=0 GGML_IFAIRY_LUT_FULLACC=0 GGML_IFAIRY_LUT_LAYOUT=compact GGML_IFAIRY_LUT_N1_FASTPATH=1` | 12.75 |
| 2025-12-18T05:51:44Z | `HEAD` | Apple M4 | 4 | 256 | `GGML_IFAIRY_LUT=1 GGML_IFAIRY_LUT_BK_BLOCKS=0 GGML_IFAIRY_LUT_BM=0 GGML_IFAIRY_LUT_FULLACC=0 GGML_IFAIRY_LUT_LAYOUT=compact GGML_IFAIRY_LUT_N1_FASTPATH=0` | 10.10 |
| 2025-12-18T05:52:13Z | `HEAD` | Apple M4 | 4 | 256 | `GGML_IFAIRY_LUT=1 GGML_IFAIRY_LUT_BK_BLOCKS=0 GGML_IFAIRY_LUT_BM=0 GGML_IFAIRY_LUT_FULLACC=0 GGML_IFAIRY_LUT_LAYOUT=compact GGML_IFAIRY_LUT_N1_FASTPATH=1` | 6.94 |
| 2025-12-18T05:52:54Z | `HEAD` | Apple M4 | 4 | 256 | `GGML_IFAIRY_LUT=1 GGML_IFAIRY_LUT_BK_BLOCKS=0 GGML_IFAIRY_LUT_BM=0 GGML_IFAIRY_LUT_FULLACC=0 GGML_IFAIRY_LUT_LAYOUT=compact GGML_IFAIRY_LUT_N1_FASTPATH=0` | 5.05 |

**3 连跑波动检查（同一命令/同一 build-rel/同一线程数）**

- `legacy`：mean `14.58`，min `14.23`，max `14.99`，range `0.76`
- `compact`：mean `13.19`，min `12.14`，max `14.10`，range `1.96`
- 解读：连续跑分时 tok/s 会随温度/后台负载明显下滑；因此所有“性能结论”都必须以至少 3 次复跑的 `min/max/mean` 为准（必要时冷却后再复测）。

**A/B（ABABAB）调优建议**

- 对容易受温度漂移影响的改动（如 `N==1` fast-path/unroll/prefetch），建议采用 `ABABAB` 交替跑（而不是 AAA 再 BBB），并在必要时加入冷却间隔。
