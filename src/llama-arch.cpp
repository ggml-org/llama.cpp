...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_TOKEN_EMBD_PROJ,                        "token_embd_proj" },
    { LLM_TENSOR_OUTPUT_PROJ,                            "output_proj" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_TOKEN_EMBD_PROJ,            {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},
    {LLM_TENSOR_OUTPUT_PROJ,                {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
