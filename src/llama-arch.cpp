...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_ADAPTER_FEED_FORWARD_LENGTH,       "%s.adapter_feed_forward_length"       },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_FFN_MOE_ADAPTER_GATE,                   "blk.%d.ffn_moe_adapter_gate"},
    { LLM_TENSOR_FFN_MOE_ADAPTER_DOWN,                   "blk.%d.ffn_moe_adapter_down_exps"},
    { LLM_TENSOR_FFN_MOE_ADAPTER_UP,                     "blk.%d.ffn_moe_adapter_up_exps"},
