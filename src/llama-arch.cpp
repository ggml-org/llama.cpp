...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_MTP_INP_EMBD,                           "mtp_input_embd" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_MTP_INP_EMBD,               {LLM_TENSOR_LAYER_INPUT,     GGML_OP_GET_ROWS}},
    {LLM_TENSOR_MTP_PRE_PROJ,               {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},
