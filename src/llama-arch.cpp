...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_C2W_TF_IN_PROJ,                         "c2w.tf.input_proj" },
    { LLM_TENSOR_C2W_TF_ATTN_NORM,                       "c2w.tf.layers.%d.attn_norm" },
    { LLM_TENSOR_C2W_TF_ATTN_Q,                          "c2w.tf.layers.%d.wq" },
    { LLM_TENSOR_C2W_TF_ATTN_K,                          "c2w.tf.layers.%d.wk" },
    { LLM_TENSOR_C2W_TF_ATTN_V,                          "c2w.tf.layers.%d.wv" },
    { LLM_TENSOR_C2W_TF_ATTN_O,                          "c2w.tf.layers.%d.wo" },
    { LLM_TENSOR_C2W_TF_ATTN_SCALE,                      "c2w.tf.layers.%d.attn_scale" },
    { LLM_TENSOR_C2W_TF_FFN_NORM,                        "c2w.tf.layers.%d.ffn_norm" },
    { LLM_TENSOR_C2W_TF_FFN_GATE,                        "c2w.tf.layers.%d.ffn_gate" },
    { LLM_TENSOR_C2W_TF_FFN_UP,                          "c2w.tf.layers.%d.ffn_up" },
    { LLM_TENSOR_C2W_TF_FFN_DOWN,                        "c2w.tf.layers.%d.ffn_down" },
    { LLM_TENSOR_C2W_TF_FFN_SCALE,                       "c2w.tf.layers.%d.ffn_scale" },
    { LLM_TENSOR_C2W_TF_NORM,                            "c2w.tf.norm" },
    { LLM_TENSOR_C2W_TF_OUT_PROJ,                        "c2w.tf.output_proj" },
    { LLM_TENSOR_C2W_UP_TRANSCONV,                       "c2w.upsample.%d.transconv" },
    { LLM_TENSOR_C2W_UP_DWCONV,                          "c2w.upsample.%d.dwconv" },
    { LLM_TENSOR_C2W_UP_NORM,                            "c2w.upsample.%d.norm" },
    { LLM_TENSOR_C2W_UP_PW1,                             "c2w.upsample.%d.pwconv1" },
    { LLM_TENSOR_C2W_UP_PW2,                             "c2w.upsample.%d.pwconv2" },
    { LLM_TENSOR_C2W_UP_GAMMA,                           "c2w.upsample.%d.gamma" },
    { LLM_TENSOR_C2W_STEM,                               "c2w.stem" },
    { LLM_TENSOR_C2W_BLOCK_SNAKE_A,                      "c2w.block.%d.alpha" },
    { LLM_TENSOR_C2W_BLOCK_SNAKE_B,                      "c2w.block.%d.beta" },
    { LLM_TENSOR_C2W_BLOCK_TRANSCONV,                    "c2w.block.%d.transconv" },
    { LLM_TENSOR_C2W_RES_SNAKE1_A,                       "c2w.block.%d.res.%d.alpha1" },
    { LLM_TENSOR_C2W_RES_SNAKE1_B,                       "c2w.block.%d.res.%d.beta1" },
    { LLM_TENSOR_C2W_RES_CONV1,                          "c2w.block.%d.res.%d.conv1" },
    { LLM_TENSOR_C2W_RES_SNAKE2_A,                       "c2w.block.%d.res.%d.alpha2" },
    { LLM_TENSOR_C2W_RES_SNAKE2_B,                       "c2w.block.%d.res.%d.beta2" },
    { LLM_TENSOR_C2W_RES_CONV2,                          "c2w.block.%d.res.%d.conv2" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_C2W_TF_IN_PROJ,             {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_TF_ATTN_NORM,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_TF_ATTN_Q,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_TF_ATTN_K,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_TF_ATTN_V,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_TF_ATTN_O,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_TF_ATTN_SCALE,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_TF_FFN_NORM,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_TF_FFN_GATE,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_TF_FFN_UP,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_TF_FFN_DOWN,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_TF_FFN_SCALE,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_TF_NORM,                {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL}},
    {LLM_TENSOR_C2W_TF_OUT_PROJ,            {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_UP_TRANSCONV,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_CONV_TRANSPOSE_1D}},
    ...
    {LLM_TENSOR_C2W_UP_PW1,                 {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_UP_PW2,                 {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_C2W_UP_GAMMA,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_STEM,                   {LLM_TENSOR_LAYER_INPUT,     GGML_OP_IM2COL}},
    {LLM_TENSOR_C2W_BLOCK_SNAKE_A,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_BLOCK_SNAKE_B,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_BLOCK_TRANSCONV,        {LLM_TENSOR_LAYER_REPEATING, GGML_OP_CONV_TRANSPOSE_1D}},
    {LLM_TENSOR_C2W_RES_SNAKE1_A,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_RES_SNAKE1_B,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_RES_CONV1,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_IM2COL}},
    {LLM_TENSOR_C2W_RES_SNAKE2_A,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_RES_SNAKE2_B,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_C2W_RES_CONV2,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_IM2COL}},
