...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_ATTN_RES_BLOCK_SIZE,               "%s.attention_residual_block_size"    },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_OUTPUT_ATTN_RES_NORM,                   "output_attn_res_norm" },
    { LLM_TENSOR_OUTPUT_ATTN_RES_PROJ,                   "output_attn_res_proj" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_OUTPUT_ATTN_RES_NORM,        {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL}},
    {LLM_TENSOR_OUTPUT_ATTN_RES_PROJ,        {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL}},
