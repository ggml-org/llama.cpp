...
enum llm_tensor {
    ...
    LLM_TENSOR_OUTPUT_ATTN_RES_NORM,
    LLM_TENSOR_OUTPUT_ATTN_RES_PROJ,
    ...
    LLM_TENSOR_C2W_CODEBOOK_EMBD,
    LLM_TENSOR_C2W_VQ_FIRST_PROJ,
    LLM_TENSOR_C2W_VQ_REST_PROJ,
    LLM_TENSOR_C2W_PRE_CONV,
    LLM_TENSOR_C2W_TF_IN_PROJ,
    LLM_TENSOR_C2W_TF_ATTN_NORM,
    LLM_TENSOR_C2W_TF_ATTN_Q,
    LLM_TENSOR_C2W_TF_ATTN_K,
    LLM_TENSOR_C2W_TF_ATTN_V,
    LLM_TENSOR_C2W_TF_ATTN_O,
    LLM_TENSOR_C2W_TF_ATTN_SCALE,
    LLM_TENSOR_C2W_TF_FFN_NORM,
    LLM_TENSOR_C2W_TF_FFN_GATE,
    LLM_TENSOR_C2W_TF_FFN_UP,
    LLM_TENSOR_C2W_TF_FFN_DOWN,
    LLM_TENSOR_C2W_TF_FFN_SCALE,
    LLM_TENSOR_C2W_TF_NORM,
    LLM_TENSOR_C2W_TF_OUT_PROJ,
    LLM_TENSOR_C2W_UP_TRANSCONV,
    LLM_TENSOR_C2W_UP_DWCONV,
    LLM_TENSOR_C2W_UP_NORM,
    LLM_TENSOR_C2W_UP_PW1,
    LLM_TENSOR_C2W_UP_PW2,
    LLM_TENSOR_C2W_UP_GAMMA,
    LLM_TENSOR_C2W_STEM,
    LLM_TENSOR_C2W_BLOCK_SNAKE_A,
    LLM_TENSOR_C2W_BLOCK_SNAKE_B,
    LLM_TENSOR_C2W_BLOCK_TRANSCONV,
    LLM_TENSOR_C2W_RES_SNAKE1_A,
    LLM_TENSOR_C2W_RES_SNAKE1_B,
    LLM_TENSOR_C2W_RES_CONV1,
    LLM_TENSOR_C2W_RES_SNAKE2_A,
    LLM_TENSOR_C2W_RES_SNAKE2_B,
    LLM_TENSOR_C2W_RES_CONV2,
