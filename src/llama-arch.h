...
enum llm_tensor {
    ...
    LLM_TENSOR_GEAR_MIX_Q,
    LLM_TENSOR_GEAR_MIX_K,
    LLM_TENSOR_GEAR_MIX_V,
    LLM_TENSOR_GEAR_MIX_OUT,
    LLM_TENSOR_GEAR_MIX_Q_NORM,
    LLM_TENSOR_GEAR_MIX_K_NORM,
    LLM_TENSOR_GEAR_MIX_KEY_CONV,
    LLM_TENSOR_GEAR_MIX_VALUE_CONV,
