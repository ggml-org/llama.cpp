...
enum llm_kv {
    ...
    LLM_KV_HYPER_CONNECTION_LOWRANK,
    LLM_KV_HYPER_CONNECTION_SINKHORN_ITERATIONS,
    LLM_KV_HYPER_CONNECTION_EPSILON,

    LLM_KV_PLE_EMBD_LENGTH,
    LLM_KV_PLE_CONV_KERNEL,
    LLM_KV_PLE_NGRAM_MULTIPLIERS,
    LLM_KV_PLE_NGRAM_VOCAB_SIZES,
    LLM_KV_PLE_NGRAM_OFFSETS,
...
enum llm_tensor {
    ...
    LLM_TENSOR_HC_MIX_NORM,
    LLM_TENSOR_HC_MIX_DOWN,
    LLM_TENSOR_HC_MIX_UP,
    LLM_TENSOR_PLE_NGRAM_EMBD,
    LLM_TENSOR_PLE_KEY,
    LLM_TENSOR_PLE_VALUE,
    LLM_TENSOR_PLE_KEY_NORM,
    LLM_TENSOR_PLE_QUERY_NORM,
    LLM_TENSOR_PLE_CONV_NORM,
