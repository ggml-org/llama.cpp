...
enum llm_tensor {
    ...
    LLM_TENSOR_TOKEN_EMBD_NORM_IMAG,
    LLM_TENSOR_TOKEN_EMBD_NORM_REAL,
    LLM_TENSOR_TOKEN_TYPES,
    LLM_TENSOR_POS_EMBD,
    LLM_TENSOR_OUTPUT,
    LLM_TENSOR_OUTPUT_NORM,
    LLM_TENSOR_OUTPUT_NORM_IMAG,
    LLM_TENSOR_OUTPUT_NORM_REAL, // ??lwt 是final norm 么
    LLM_TENSOR_ROPE_FREQS,
    LLM_TENSOR_ROPE_FACTORS_LONG,
    LLM_TENSOR_ROPE_FACTORS_SHORT,
    LLM_TENSOR_ATTN_Q,
    LLM_TENSOR_ATTN_Q_IMAG,
    LLM_TENSOR_ATTN_Q_REAL,
    LLM_TENSOR_ATTN_K,
    LLM_TENSOR_ATTN_K_IMAG,
    LLM_TENSOR_ATTN_K_REAL,
    LLM_TENSOR_ATTN_V,
    LLM_TENSOR_ATTN_V_IMAG,
    LLM_TENSOR_ATTN_V_REAL,
    LLM_TENSOR_ATTN_QKV,
    LLM_TENSOR_ATTN_OUT,
    LLM_TENSOR_ATTN_OUT_IMAG,
    LLM_TENSOR_ATTN_OUT_REAL,
    LLM_TENSOR_ATTN_NORM,
    LLM_TENSOR_ATTN_NORM_2,
    LLM_TENSOR_ATTN_OUT_NORM,
    LLM_TENSOR_ATTN_POST_NORM, // ??lwt 是哪个POST_NORM 没有 PRE_NORM ATTN_LAYER_NORM
    LLM_TENSOR_ATTN_ROT_EMBD,
    LLM_TENSOR_ATTN_SINKS,
    LLM_TENSOR_FFN_GATE_INP,
    LLM_TENSOR_FFN_GATE_INP_SHEXP,
    LLM_TENSOR_FFN_NORM,
    LLM_TENSOR_FFN_NORM_IMAG,
    LLM_TENSOR_FFN_NORM_REAL,
    LLM_TENSOR_FFN_POST_NORM,
    LLM_TENSOR_FFN_GATE,
    LLM_TENSOR_FFN_GATE_IMAG,
    LLM_TENSOR_FFN_GATE_REAL,
    LLM_TENSOR_FFN_DOWN,
    LLM_TENSOR_FFN_DOWN_IMAG,
    LLM_TENSOR_FFN_DOWN_REAL,
    LLM_TENSOR_FFN_UP,
    LLM_TENSOR_FFN_UP_IMAG,
    LLM_TENSOR_FFN_UP_REAL,
    LLM_TENSOR_FFN_ACT,
    ...
    LLM_TENSOR_FFN_SUB_NORM_IMAG,
    LLM_TENSOR_FFN_SUB_NORM_REAL,
