...
enum llm_kv {
    ...
    LLM_KV_ENGRAM_HC_MULT,
    LLM_KV_ENGRAM_CONV_RMS_NORM_EPS,
    LLM_KV_ENGRAM_HASH_MAX_NGRAM_SIZE,
    LLM_KV_ENGRAM_HASH_N_HEAD_PER_NGRAM,
    LLM_KV_ENGRAM_HASH_N_EMBED_PER_NGRAM,
    LLM_KV_ENGRAM_HASH_SEED,
    LLM_KV_ENGRAM_HASH_PAD_ID,
    LLM_KV_ENGRAM_HASH_TOKENIZER_VOCAB_SIZE,
    LLM_KV_ENGRAM_HASH_N_ENGRAM_LAYERS,
    LLM_KV_ENGRAM_HASH_ENGRAM_VOCAB_SIZE,
    LLM_KV_ENGRAM_HASH_LAYER_IDS,
    LLM_KV_ENGRAM_HASH_LAYER_MULTIPLIERS,
    LLM_KV_ENGRAM_HASH_LAYER_VOCAB_SIZES,
    LLM_KV_ENGRAM_HASH_COMPRESSED_LOOKUP,    
