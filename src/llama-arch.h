...
enum llm_kv {
    ...
    LLM_KV_RVQ_CODEBOOK_COUNT,
    LLM_KV_RVQ_VOCAB_SIZES,

    LLM_KV_MIMO_ENCODER_BLOCK_COUNT,
    LLM_KV_MIMO_ENCODER_EMBEDDING_LENGTH,
    LLM_KV_MIMO_ENCODER_HEAD_COUNT,
    LLM_KV_MIMO_ENCODER_FEED_FORWARD_LENGTH,
    LLM_KV_MIMO_GROUP_SIZE,
    LLM_KV_MIMO_INPUT_FULL_ATTENTION,
    LLM_KV_MIMO_SPEECH_ZEROEMB_IDX,
    LLM_KV_MIMO_TEXT_EMPTY_IDX,
...
enum llm_tensor {
    ...
    LLM_TENSOR_A_MIMO_SPEECH_EMBD,      //MIMO_V2_ASR
    LLM_TENSOR_A_MIMO_SPEECH_DOWNCAST,  //MIMO_V2_ASR
};
