...
struct llama_model_granite_speech_5 : public llama_model_base {
    llama_model_granite_speech_5(const struct llama_model_params & params) : llama_model_base(params) {}
    void load_arch_hparams(llama_model_loader & ml) override;
    void load_arch_tensors(llama_model_loader & ml) override;
