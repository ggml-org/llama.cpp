...
void llama_model_glm4_moe_lite::load_arch_tensors(llama_model_loader &) {
    LLAMA_LOAD_LOCALS;
...
// Adapted from step35 graph_mtp, with MLA attention from deepseek2.
llama_model_glm4_moe_lite::graph_mtp::graph_mtp(const llama_model & model, const llm_graph_params & params)
    ...
    // MLA attention (same as deepseek2 main graph)
    {
        ggml_tensor * q;
