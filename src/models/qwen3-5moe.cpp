...
ggml_tensor * llm_build_qwen3_5_moe::build_norm_gated(
        ggml_tensor * input,
        ggml_tensor * weights,
        ggml_tensor * gate,
        int           layer) {
...
ggml_tensor * llm_build_qwen3_5_moe::build_layer_attn(
...
std::pair<ggml_tensor *, ggml_tensor *> llm_build_qwen3_5_moe::build_qkvz(
                ggml_tensor * input,
                        int   il) {
...
ggml_tensor * llm_build_qwen3_5_moe::build_layer_attn_linear(
