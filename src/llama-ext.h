...
// total size of the dense FFN weights (gate, up, down) of layer il, 0 for MoE layers or il >= n_layer_all
LLAMA_API size_t llama_model_layer_ffn_nbytes(const llama_model * model, uint32_t il);
