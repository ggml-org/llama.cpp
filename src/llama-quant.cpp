        ...
        if (qs.params->token_embedding_type < GGML_TYPE_COUNT) {
            ...
            if (ftype == LLAMA_FTYPE_MOSTLY_IQ2_XXS || ftype == LLAMA_FTYPE_MOSTLY_IQ2_XS ||
                ...
                new_type = GGML_TYPE_IQ3_S;
                       ...
                       ftype == LLAMA_FTYPE_MOSTLY_Q1_5_K || ftype == LLAMA_FTYPE_MOSTLY_Q2_K_S_NEW) {
...
static bool tensor_type_requires_imatrix(const ggml_tensor * t, const ggml_type dst_type, const llama_ftype ftype) {
    return (dst_type == GGML_TYPE_IQ2_XXS || dst_type == GGML_TYPE_IQ2_XS || dst_type == GGML_TYPE_IQ3_XXS ||
            dst_type == GGML_TYPE_IQ1_S || dst_type == GGML_TYPE_IQ2_S || dst_type == GGML_TYPE_IQ1_M ||
...
static void llama_model_quantize_impl(const std::string &                 fname_inp,
    ...
    switch (params->ftype) {
        ...
        case LLAMA_FTYPE_MOSTLY_TQ2_0:
            ...
            break;
        case LLAMA_FTYPE_MOSTLY_Q1_5_K:
            default_type = GGML_TYPE_Q1_5_K;
            break;
        case LLAMA_FTYPE_MOSTLY_Q2_K_S_NEW:
            default_type = GGML_TYPE_Q2_K_S;
            break;
    ...
    llama_model_loader       ml(fname_inp, splits, use_mmap, /*use_direct_io*/ false, /*check_tensors*/ true,
    ...
    if (!params->imatrix && params->dry_run && will_require_imatrix) {
        LLAMA_LOG_WARN(
            "%s: WARNING: dry run completed successfully, but actually completing this quantization will require an "
            "imatrix!\n",
            __func__);
    }
