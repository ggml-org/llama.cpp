...
struct llm_build_mamba : public llm_graph_context {
    ...
    ggml_tensor * build_mamba_layer(
        ...
        ggml_tensor * conv_states_all = mem_ctx->get_r_l(il);
        ggml_tensor * ssm_states_all  = mem_ctx->get_s_l(il);
        ...
        ggml_build_forward_expand(
                ...
                ggml_cpy(
                    ...
                    ggml_view_1d(
                        ...
                        mem_ctx->get_s_l(il),
                        hparams.n_embd_s() * n_seqs,
                        hparams.n_embd_s() * kv_head * ggml_element_size(mem_ctx->get_s_l(il))
                        )
                    )
                );
