        ...
        case LLM_ARCH_OPT:
            {
                ...
                // OPT uses uniform architecture, so if n_ff_arr is not set in GGUF, set it manually
                if (hparams.n_ff_arr[0] == 0) {
                    const uint32_t n_ff = hparams.n_embd * 4; // OPT uses 4x expansion ratio
                    for (uint32_t il = 0; il < hparams.n_layer; ++il) {
                        hparams.n_ff_arr[il] = n_ff;
                    }
                }
                ...
                switch (hparams.n_layer) {
                    case 12: type = LLM_TYPE_SMALL; break;
                    case 24: type = LLM_TYPE_MEDIUM; break;
                    case 32: type = LLM_TYPE_1_3B; break;
                    case 40: type = LLM_TYPE_13B; break;
                    case 48: type = LLM_TYPE_30B; break;
