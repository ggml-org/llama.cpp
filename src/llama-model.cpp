            ...
            case LLM_ARCH_PARAM2MOE:
                {
                    ...
                    GGML_ASSERT(hparams.n_expert > 0 && "n_expert must be > 0 for PARAM2MOE MoE layers");
                    GGML_ASSERT(hparams.n_expert_used > 0 && "n_expert_used must be > 0 for PARAM2MOE MoE layers");
