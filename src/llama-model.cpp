        ...
        default:
            {
                ...
                if (hparams.swa_type != LLAMA_SWA_TYPE_NONE) {
                    ...
                    mixed_config.quantization_threshold = 64;        //> When tokens > threshold + window size, compress threshold window into Quant.
                    mixed_config.fp16_window_size = 64;              //> Max 8 tokens in FP16 window
