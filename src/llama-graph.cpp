...
ggml_tensor * llm_graph_context::build_moe_ffn(
    ...
    if (hparams.n_expert_groups > 1 && n_tokens > 0) {
        ...
        selection_probs = ggml_set_rows(ctx0, ggml_fill_inplace(ctx0, selection_groups, -INFINITY), selection_probs, expert_groups); // [n_exp_per_group, n_expert_groups, n_tokens]
