...
Note: Trivial editor autocompletions do not require disclosure.
...
Maintainers reserve the right to decline review or close pull requests that satisfy any of the following conditions:
