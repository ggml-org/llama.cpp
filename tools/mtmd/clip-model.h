...
struct clip_hparams {
    ...
    std::vector<int32_t> speech_feature_layer;
    ...
    bool is_speech_feature_layer(int32_t layer) const {
        return std::find(speech_feature_layer.begin(), speech_feature_layer.end(), layer) != speech_feature_layer.end();
    }
};
