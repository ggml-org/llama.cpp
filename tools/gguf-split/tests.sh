...
#    cp "$WORK_PATH/ggml-model-split-32-tensors-000${i}-of-00012.gguf" "$WORK_PATH/ggml-model-split-32-tensors-copy-000${i}-of-00012.gguf"
#done
#$SPLIT --merge --delete-files $WORK_PATH/ggml-model-split-32-tensors-copy-00001-of-00012.gguf $WORK_PATH/ggml-model-merge-3.gguf
#echo PASS
#echo

# 7b. Test the merged model is loading properly
#$MAIN -no-cnv --model $WORK_PATH/ggml-model-merge-3.gguf --n-predict 32
#echo PASS
#echo

# 7c. Test the files were deleted
#for i in $(seq -w 1 12); do
#    test ! -f "$WORK_PATH/ggml-model-split-32-tensors-copy-000${i}-of-00012.gguf"
#done
#echo PASS
#echo
