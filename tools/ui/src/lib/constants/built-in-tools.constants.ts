...
export const BUILTIN_TOOL_UI: Readonly<Record<BuiltInTool, BuiltinToolUiEntry>> = {
	...
	[BuiltInTool.MEMORY_DROP]: { icon: Brain, label: 'Forget memory', source: ToolSource.FRONTEND },
	[BuiltInTool.MEMORY_OPEN]: { icon: Brain, label: 'Open memory', source: ToolSource.FRONTEND },
	[BuiltInTool.MEMORY_WRITE]: { icon: Brain, label: 'Write memory', source: ToolSource.FRONTEND },
