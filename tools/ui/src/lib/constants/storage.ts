...
/** @deprecated Use {@link THINKING_ENABLED_DEFAULT_LOCALSTORAGE_KEY} instead */
export const DEPRECATED_THINKING_ENABLED_DEFAULT_LOCALSTORAGE_KEY = `${STORAGE_APP_NAME_DEPRECATED}.thinkingEnabledDefault`;
/** @deprecated Use {@link REASONING_EFFORT_DEFAULT_LOCALSTORAGE_KEY} instead */
export const DEPRECATED_REASONING_EFFORT_DEFAULT_LOCALSTORAGE_KEY = `${STORAGE_APP_NAME_DEPRECATED}.reasoningEffortDefault`;
...
export const NEW_TO_DEPRECATED_MAP: Record<string, string> = {
	...
	[THINKING_ENABLED_DEFAULT_LOCALSTORAGE_KEY]: DEPRECATED_THINKING_ENABLED_DEFAULT_LOCALSTORAGE_KEY,
	[REASONING_EFFORT_DEFAULT_LOCALSTORAGE_KEY]: DEPRECATED_REASONING_EFFORT_DEFAULT_LOCALSTORAGE_KEY,
