...
export const REGEX_PATTERNS = {
	...
	BUNDLE_CSS_FILE: /^bundle\..+\.css$/,
	WORKBOX_FILE: /^workbox-[^.]+\.js$/,
...
// Used by vite.config.ts SvelteKitPWA workbox.runtimeCaching
...
// Keep in sync with tools/server/server-http.cpp public_endpoints
export const API_CACHING_PATTERNS = {
	V1_API: /^\/v1\/.*/, // All /v1/* API routes
	STATIC_API: /^\/(health|props|models|tools|slots|cors-proxy).*/ // Static UI endpoints
} as const;
