...
- `--tts-speaker-file` is not supported
...
llama-tts -m kani-tts-2.gguf \
    -mm mmproj-nemo-nano-codec.gguf \
    -p "Hello world" \
    --tts-lang en_us \
...
Download [KaniTTS-2 English](https://huggingface.co/nineninesix/kani-tts-2-en) and the `.nemo` archive from [NeMo Nano Codec 22 kHz / 0.6 kbps / 12.5 fps](https://huggingface.co/nvidia/nemo-nano-codec-22khz-0.6kbps-12.5fps) into separate directories:
