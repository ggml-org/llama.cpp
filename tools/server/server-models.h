...
#define CMD_CHILD_TO_ROUTER_ERROR "cmd_child_to_router:error:" // followed by a flattened error message
...
public:
    ...
    // record the last error reported by a child process (thread-safe)
