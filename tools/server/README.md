...
| `--chat-template-verify, --no-chat-template-verify` | whether verify provided chat template against built-in chat presets (default: enabled)<br/>(env: LLAMA_ARG_CHAT_TEMPLATE_VERIFY) |
