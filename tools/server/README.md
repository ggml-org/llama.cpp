...
| `--host HOST` | IP addresses to listen on, comma-separated, or UNIX socket paths ending in .sock; overlapping addresses result in undefined behavior (default: 127.0.0.1)<br/>(env: LLAMA_ARG_HOST) |
