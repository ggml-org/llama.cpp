...
| `--reasoning-budget-warn-offset N` | inject the reasoning budget message N tokens before the cutoff, reserving time for the model to wrap up (default: 0)<br/>(env: LLAMA_ARG_THINK_BUDGET_WARN_OFFSET) |
