...
export const SETTING_CONFIG_INFO: Record<string, string> = {
	...
	gpu_sampling:
		'Enable GPU-based samplers. When enabled, supported samplers run on the GPU for faster sampling.',
	gpu_dist:
		'Perform the final distribution sampling step on the GPU. Requires GPU sampling to be enabled.',
	temperature:
