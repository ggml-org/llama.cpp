// default_speaker.h
#ifndef DEFAULT_SPEAKER_H
#define DEFAULT_SPEAKER_H

#include "json.hpp"

namespace DefaultSpeaker {

inline const char* jsonDataStr = R"(
{
...
inline nlohmann::ordered_json getJsonData() {
    static const nlohmann::ordered_json parsedJson = nlohmann::ordered_json::parse(jsonDataStr);
    return parsedJson;
}

} // namespace DefaultSpeaker

#endif // DEFAULT_SPEAKER_H