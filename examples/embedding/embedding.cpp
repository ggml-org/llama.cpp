...
int main(int argc, char ** argv) {
    ...
    // Commented out - jina-reranker-v3 is a causal model
    ...
    // allocate output
    // Use n_embd for per-token embeddings (pooling=none) as it represents the internal hidden state dimension
    // n_embd_out is the output embedding dimension after pooling, which may differ for some models
