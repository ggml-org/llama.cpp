...
These are ready-to-use models, most of them come with `Q4_K_M` quantization by default.  They can be found at the Huggingface page of the ggml.org: https://huggingface.co/ggml-org
