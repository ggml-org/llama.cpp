...
| GGML_CUDA_FORCE_CUBLAS_COMPUTE_32F | Boolean                | false   | Force the use of CUBLAS_COMPUTE_32F as compute type in cuBLAS. This should prevent possible numerical overflows in exchange for slightly slower prompt processing.  |
