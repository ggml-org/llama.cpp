...
| GGML_CUDA_FA_QUANTS           | Preset or type combinations | minimal | Select FlashAttention KV cache type combinations. Presets: `minimal` compiles f16-f16, bf16-bf16, q4_0-q4_0, and q8_0-q8_0; `all` compiles every combination; `symmetric` compiles every X-X combination; `viable` compiles combinations where K is at least as precise as V. A custom `type_K-type_V` list separated by `;` is also accepted. Custom lists always include f16-f16. Legal types: f16, bf16, q4_0, q4_1, q5_0, q5_1, q8_0. |
