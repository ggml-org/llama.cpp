...
Cross-compilation is supported on **Linux X86** and **Windows X86** hosts. The resulting binaries are deployed to and run on the target **Qualcomm Snapdragon ARM64 Linux** IoT device.
