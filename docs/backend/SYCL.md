...
| GGML_SYCL_DEV_DEBUG   | 0 (default) or 1 | Enable log function: GGML_SYCL_DEV_DEBUG() for development by replacing GGML_SYCL_DEBUG() in special codes. Restore to GGML_SYCL_DEBUG() before commit code.|
