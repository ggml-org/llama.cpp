...
public:
    test_gbnf_generation() : compound_test("test_gbnf_generation") {
        // Test literal
        ...
        add_test([](test_harness h) {
            ...
            h.assert_equals("has_proper_sequence", true, gbnf.find("root ::= \"hello\" \" \" \"world\"") != std::string::npos);
        }, "sequence grammar");
        ...
        add_test([](test_harness h) {
            ...
            h.assert_equals("has_proper_optional", true, gbnf.find("root ::= \"hello\" \" world\"?") != std::string::npos);
        }, "optional grammar");
        ...
        add_test([](test_harness h) {
            ...
            h.assert_equals("has_proper_until", true, gbnf.find("root ::= ([^<] | \"<\" [^/] | \"</\" [^t] | \"</t\" [^a] | \"</ta\" [^g] | \"</tag\" [^>])*") != std::string::npos);
        }, "until grammar");
