...
test_gbnf_generation::test_gbnf_generation() : compound_test("test_gbnf_generation") {
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.literal("hello"); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser(
                [](parser_builder & p) { return p.literal("hello") + p.literal(" ") + p.literal("world"); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.literal("cat") | p.literal("dog"); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.one_or_more(p.one("[0-9]")); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.zero_or_more(p.one("[a-z]")); });
    ...
    add_test(
        [](test_harness h) {
            auto parser =
                build_parser([](parser_builder & p) { return p.literal("hello") + p.optional(p.literal(" world")); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.until("</tag>"); });
    ...
    add_test(
        [](test_harness h) {
            auto parser =
                build_parser([](parser_builder & p) { return p.one_or_more(p.literal("a") | p.literal("b")); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.literal("hello") << p.literal("world"); });
