...
test_partial_parsing::test_partial_parsing() : compound_test("test_partial_parsing") {
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.literal("<think>") + p.literal("</think>"); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.literal("begin") + p.literal("end"); });
    ...
    add_test(
        [](test_harness h) {
            ...
            auto ctx    = parser_context("<think></", false);
            auto result = parser.parse(ctx);
    ...
    add_test(
        [](test_harness h) {
            ...
            auto ctx    = parser_context("<think>I am parser", false);
            auto result = parser.parse(ctx);
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.literal("option1") | p.literal("option2"); });
    ...
    add_test(
        [](test_harness h) {
            auto parser =
                build_parser([](parser_builder & p) { return p.literal("choice_a") | p.literal("choice_b"); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.literal("first") | p.literal("second"); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.literal("alpha") | p.literal("beta"); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.literal("good") | p.literal("better"); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.zero_or_more(p.literal("ab")); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.zero_or_more(p.literal("xy")); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.zero_or_more(p.literal("test")); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.one_or_more(p.literal("repeat")); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.one_or_more(p.literal("ab")); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.one_or_more(p.literal("single")); });
    ...
    add_test(
        [](test_harness h) {
            auto parser = build_parser([](parser_builder & p) { return p.one_or_more(p.literal("fail")); });
