...
private:
    ...
    // Helper methods
    static class parser create_command_r7b_parser();
    static void test_command_r7b_parser(const class parser & p, const std::string & input, bool partial, bool print_results = false);
