...
static void test_gpu_multi_sequence_sampling(const char * model_path) {
    ...
    GGML_ASSERT(seq0_token == 29892);
    GGML_ASSERT(seq0_token_str == ",");
    ...
    GGML_ASSERT(seq1_token == 650);
    GGML_ASSERT(seq1_token_str == "one");
...
static void test_gpu_dist_sampling(const char * model_path) {
    test_model_context test_ctx;
