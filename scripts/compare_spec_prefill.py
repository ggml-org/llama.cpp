...
def parse_args():
    ...
    parser.add_argument("-hfd", "--hf-repo-draft", "--draft-hf", help="Hugging Face repo for draft model (<user>/<model>[:quant])")
    ...
    parser.add_argument("-ngld", "--n-gpu-layers-draft", type=int, default=99, help="Number of GPU layers for draft model (default: 99)")
